...
absorption | int | 受到伤害时，扣除黄心前，实体拥有的黄心血量（见[AttrType枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AttrType.html>)的ABSORPTION）  
cause | str | 伤害来源，详见Minecraft枚举值文档的[ActorDamageCause](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/ActorDamageCause.html>)  
...
itemList | list(dict) | 掉落物品列表，每个元素为一个itemDict，格式可参考[物品信息字典](<../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)  
...
---|---|---  
entityId | str | 生物Id  
itemDict | dict | 扔出的物品的[物品信息字典](<../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)  
...
attributeBuffType | int | 状态类型，参考[AttributeBuffType](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AttributeBuffType.html>)  
...
无
  ...
  * 备注
    ...
    * 注意：该事件触发表示运动器播放顺利完成，手动调用的[StopEntityMotion](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/行为.html#StopEntityMotion>)、[RemoveEntityMotion](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/行为.html#RemoveEntityMotion>)以及实体被销毁导致的运动器停止不会触发该事件。
...
---|---|---  
entityId | str | 生物Id  
itemDict | dict | 拾取的物品的[物品信息字典](<../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)  
...
无
  ...
  * 备注
    ...
    * 注意：不能在该事件回调中对此玩家手持物品进行修改，如[SpawnItemToPlayerCarried](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/背包.html#spawnitemtoplayercarried>)、[ChangePlayerItemTipsAndExtraId](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/背包.html#changeplayeritemtipsandextraId>)等接口
...
targetId | str | 碰撞目标id  
hitFace | int | 撞击在方块上的面id，参考[Facing枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/Facing.html>)  
x | float | 碰撞x坐标  
y | float | 碰撞y坐标  
z | float | 碰撞z坐标  
