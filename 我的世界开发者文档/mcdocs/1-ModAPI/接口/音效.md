...
-6 | **位置距离本地玩家距离大于16格，跳过音效播放** （绑定实体的音效不受此限制）  
    ...
    * 该接口触发[PlaySoundClientEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/音效.html#playsoundclientevent>)
...
bool | 播放是否成功  
  * 备注
    ...
    * 该接口触发[PlayMusicClientEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/音效.html#playmusicclientevent>)
    * 与示例对应的sound_definitions.json配置：
[code]{
            "Gsound001": {
              "category": "music",
