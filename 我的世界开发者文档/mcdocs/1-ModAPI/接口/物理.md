...
eventMask | int | [PxEventMask枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PxEventMask.html>)，用于监听碰撞事件，默认为PxEventMask.Null，即不需要碰撞事件  
...
mode | int | [PxForceMode枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PxForceMode.html>)，施加力/冲量时使用的模式  
  * 返回值
...
参数名 | 数据类型 | 说明  
---|---|---  
flag | int | [PxActorFlag枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PxActorFlag.html>)  
  * 返回值
...
参数名 | 数据类型 | 说明  
---|---|---  
flag | int | [PxRigidBodyFlag枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PxRigidBodyFlag.html>)  
val | bool | 开关  
  * 返回值
...
参数名 | 数据类型 | 说明  
---|---|---  
flag | int | [PxRigidDynamicLockFlag枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PxRigidDynamicLockFlag.html>)  
  * 返回值
