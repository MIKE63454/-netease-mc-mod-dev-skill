...
锁定当前世界游戏类型（仅本次游戏有效），玩家无法通过指令、游戏菜单或相关api如[SetPlayerGameType](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/游戏模式.html#setplayergametype>)和[SetDefaultGameType](<#setdefaultgametype>)修改游戏类型，包括默认游戏类型和个人游戏类型
