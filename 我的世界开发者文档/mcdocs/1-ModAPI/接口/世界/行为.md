...
entityId | str | 攻击实体id  
cause | str | 伤害类型，默认值是EntityAttack，详见Minecraft枚举值文档的[ActorDamageCause](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/ActorDamageCause.html>)  
...
facing | int | 点击方块的面向，详见[Facing枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/Facing.html>)  
  * 返回值
