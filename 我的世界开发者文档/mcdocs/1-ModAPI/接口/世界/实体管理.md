...
bool | 是否注册成功  
  * 备注
    ...
    * 回调函数传入的参数dict 参数名 | 类型 | 解释  
---|---|---  
AOIName | str | 注册时传入的感应区域名  
entityType | int | 详见[EntityType枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/EntityType.html>)  
...
filterType | minecraftEnum | [RayFilterType枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/RayFilterType.html>)（选填，默认为serverApi.GetMinecraftEnum().RayFilterType.OnlyEntities）  
  * 返回值
