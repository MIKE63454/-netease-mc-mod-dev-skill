...
参数名 | 数据类型 | 说明  
---|---|---  
biomeType | int | [BiomeType枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/BiomeType.html>)  
change | int | [Change枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/Change.html>)  
