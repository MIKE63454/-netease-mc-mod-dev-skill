...
数据类型 | 说明  
---|---  
dict | [方块基本信息字典](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#方块基本信息字典#方块基本信息字典>)  
  * 备注
...
---|---|---  
blockName | str | 方块identifier  
infoDict | dict | 方块的[方块基本信息字典](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#方块基本信息字典#方块基本信息字典>)  
