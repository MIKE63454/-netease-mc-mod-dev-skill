...
参数名 | 数据类型 | 说明  
---|---|---  
slot | int | 槽位，详见枚举[酿造台槽位](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/BrewingStandSlotType.html>)  
...
dict | [物品信息字典](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)，没有物品则返回None  
  * 备注
    ...
    * 3.8新增的收纳袋的userdata与箱子类的Items列表不同，它的格式为 {'bundle_weight': {'**type** ': 3, '**value** ': 7}, 'storage_item_component_content': []} 其中bundle_weight表示收纳袋当前的重量值，示例表示它里面有7个普通可堆叠物品，而storage_item_component_content与箱子的Items类似，但即使槽位为空，它也包含64个元素
  * 示例
```python
    import mod.server.extraServerApi as serverApi
...
---|---|---  
playerId | str | 玩家id  
containerId | int | [开放容器Id枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/OpenContainerId.html>)  
getUserData | bool | 是否获取userData，默认为False  
  * 返回值
...
dict | [物品信息字典](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)，没有物品则返回None  
  * 备注
    ...
    * 需要在事件[CraftItemOutputChangeServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/物品.html#CraftItemOutputChangeServerEvent>)的监听函数里面才能获取正确的结果
...
---|---|---  
playerId | str | 玩家id  
slot | int | 容器槽位。在isNeteaseUI为True时代表netease_ui_container中对应槽位；isNeteaseUI为False时含义见：[容器类型枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PlayerUISlot.html>)  
getUserData | bool | 是否获取userData，默认为False  
...
playerId | str | 玩家id  
slot | int | 容器槽位。在isNeteaseUI为True时代表netease_ui_container中对应槽位；isNeteaseUI为False时含义见：[容器类型枚举](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/PlayerUISlot.html>)  
itemDict | dict | [物品信息字典](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)，没有物品则返回None  
