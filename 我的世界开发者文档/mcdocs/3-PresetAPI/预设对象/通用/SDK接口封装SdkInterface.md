...
[GetBlockStates](<#getblockstates>) | **[服务端]** | 获取[ 方块状态 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)  
[SetBlockStates](<#setblockstates>) | **[服务端]** | 设置[ 方块状态 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)  
[GetBlockAuxValueFromStates](<#getblockauxvaluefromstates>) | **[服务端]** | 根据方块名称和[ 方块状态 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)获取方块附加值AuxValue  
[GetBlockStatesFromAuxValue](<#getblockstatesfromauxvalue>) | **[服务端]** | 根据方块名称和方块附加值AuxValue获取[ 方块状态 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)  
...
[LocateNeteaseFeatureRule](<#locateneteasefeaturerule>) | **[服务端]** | 与[/locate指令 (opens new window)](<https://zh.minecraft.wiki/w/%E5%91%BD%E4%BB%A4/locate>)相似，用于定位[ 网易自定义特征规则 ](<../../../../mcguide/20-玩法开发/15-自定义游戏内容/4-自定义维度/4-自定义特征.html#特征规则（feature-rules）>)  
...
[GetScreenViewInfo](<#getscreenviewinfo>) | **[客户端]** | 获取游戏视角信息。分辨率为1313，618时，画布是376，250的2倍，所以viewport得到的是1313 + (2-(1313%2))，y值类似，可参考[ 《我的世界》界面适配方法 ](<../../../../mcguide/18-界面与交互/1-界面编辑器使用说明.html#《我的世界》界面适配方法>)  
...
[GetUserDataInEvent](<#getuserdatainevent>) | **[客户端]**/**[服务端]** | 使物品相关客户端事件的[ 物品信息字典 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)参数带有userData。在mod初始化时调用即可  
...
数据类型 | 说明  
---|---  
dict | [ 方块信息字典 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#方块信息字典>)  
  * 备注
...
---|---|---  
pos | tuple(int,int,int) | 方块位置  
blockDict | dict | [ 方块信息字典 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#方块信息字典>)  
...
entityType | int | 期望响应的实体类型，不传则响应所有的实体类型[EntityType枚举](<../../../1-ModAPI/枚举值/EntityType.html>)  
  * 返回值
...
参数名 | 数据类型 | 说明  
---|---|---  
featureType | int | 原版的结构类型，[StructureFeatureType](<../../../1-ModAPI/枚举值/StructureFeatureType.html>)枚举  
...
rot | tuple(float,float) | （上下角度，左右角度）实体水平方向的俯仰角度和竖直方向的旋转角度，单位是角度而不是弧度。[MC坐标系说明](<../../../../mcguide/20-玩法开发/10-基本概念/10-Vector3.html>)  
...
获取游戏视角信息。分辨率为1313，618时，画布是376，250的2倍，所以viewport得到的是1313 + (2-(1313%2))，y值类似，可参考[ 《我的世界》界面适配方法 ](<../../../../mcguide/18-界面与交互/1-界面编辑器使用说明.html#《我的世界》界面适配方法>)
...
数据类型 | 说明  
---|---  
int | [GameType枚举](<../../../1-ModAPI/枚举值/GameType.html>)  
  * 示例
```python
...
---|---|---  
playerId | str | 玩家ID  
posType | int | [ItemPosType枚举](<../../../1-ModAPI/枚举值/ItemPosType.html>)  
...
数据类型 | 说明  
---|---  
dict | [ 物品信息字典 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)，没有物品则返回None  
  * 示例
```python
...
数据类型 | 说明  
---|---  
list(tuple(int,int)) | list中每个tuple由附魔类型([EnchantType枚举](<../../../1-ModAPI/枚举值/EnchantType.html>))和附魔等级组成。没有附魔则为空list  
  * 示例
```python
...
参数名 | 数据类型 | 说明  
---|---|---  
itemDict | dict | [ 物品信息字典 ](<../../../../mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)  
...
参数名 | 数据类型 | 说明  
---|---|---  
biomeType | int | [BiomeType枚举](<../../../1-ModAPI/枚举值/BiomeType.html>)  
change | int | [Change枚举](<../../../1-ModAPI/枚举值/Change.html>)  
entityType | int | [EntityType枚举](<../../../1-ModAPI/枚举值/EntityType.html>)  
