...
![transaction_client](/dev/mcmanual/mc-dev/assets/img/transaction_client.dfadf87e.png)

#### lobby/game通信接口

发往lobby/game消息的接口如下

![transaction_game](/dev/mcmanual/mc-dev/assets/img/transaction_game.f88d8feb.png)

#### 控制服通信接口

发往控制服消息的接口如下

![transaction_master](/dev/mcmanual/mc-dev/assets/img/transaction_master.1a6c99af.png)

#### 功能服通信接口

发往功能服消息的接口如下

![transaction_service](/dev/mcmanual/mc-dev/assets/img/transaction_service.cdd1d2dc.png)
...
![tranasaction_rpc](/dev/mcmanual/mc-dev/assets/img/tranasaction_rpc.b0b95759.png) Apollo通信相关api。
