...
| app_verion  
---|---  
game | 3.8.0.release20260422  
proxy | 3.8.0.release20260422  
master | 3.8.0.release20260422  
service | 3.8.0.release20260422  
  2. 发布Apollo2.0 3.8正式包

引擎及插件版本分别是：

| app_verion  
---|---  
proxy | 3.8.0.java.release20260422  
master | 3.8.0.java.release20260422  
geyser | 3.8.0.java.release20260422  
...
注：由于Viaversion转换1.20.5版本头颅（模型）会过滤掉非法昵称的信息，导致自定义方块和中文昵称的头颅（模型）出错，因此无法直接使用官网版本。可选择MCS内容库中的"ViaVersion-5.5.1"资源或自行修改。
...
| app_verion  
---|---  
game | 3.8.0.beta20260325  
proxy | 3.8.0.beta20260325  
master | 3.8.0.beta20260325  
service | 3.8.0.beta20260325  
  2. 发布Apollo2.0 3.8beta包

引擎及插件版本分别是：

| app_verion  
---|---  
proxy | 3.8.0.java.beta20260325  
master | 3.8.0.java.beta20260325  
geyser | 3.8.0.java.beta20260325  
BungeeMaster插件 | 1.0.2-SNAPSHOT  
SpigotMaster插件 | 1.3.13-SNAPSHOT  
...
| app_verion  
---|---  
game | 3.7.0.release20260128  
proxy | 3.7.0.release20260128  
master | 3.7.0.release20260128  
service | 3.7.0.release20260128  
  2. 发布Apollo2.0 3.7正式包

引擎及插件版本分别是：

| app_verion  
---|---  
proxy | 3.7.0.java.release20260128  
master | 3.7.0.java.release20260128  
geyser | 3.7.0.java.release20260128  
BungeeMaster插件 | 1.0.2-SNAPSHOT  
SpigotMaster插件 | 1.3.13-SNAPSHOT  
...
| app_verion  
---|---  
game | 3.7.0.beta20251231  
proxy | 3.7.0.beta20251231  
master | 3.7.0.beta20251231  
service | 3.7.0.beta20251231  
  2. 发布Apollo2.0 3.7beta包

引擎及插件版本分别是：

| app_verion  
---|---  
proxy | 3.7.0.java.beta20251231  
master | 3.7.0.java.beta20251231  
geyser | 3.7.0.java.beta20251231  
BungeeMaster插件 | 1.0.2-SNAPSHOT  
SpigotMaster插件 | 1.3.13-SNAPSHOT  
...
该问题将于Apollo 3.3版本修复，在当前版本中，请不要使用[RecipesSyncOnLogin](<./4-SDK/6-大厅与游戏服API.html?key=RecipesSyncOnLogin&docindex=1&type=0>)接口关闭服务器配方表的同步功能。
...
## 2024.08.27 更新内容
  ...
  1. Apollo 更新内容
     ...
     * deploy.json添加了packet_threshold字段可限制客户端发包频率阈值，详见[deploy.json](<../../mcguide/27-手机网络游戏/课程3：简易网络服模板部署与常见操作/第4节：网络服进阶配置.html#deploy-json>)
...
新增开启玩家发包数据统计接口 [GetPlayerIpHash](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#getplayeriphash>)
...
service | 2.8.0.release20230907  
  2. Apollo2.0 更新内容
     ...
     * formUi文档添加对不同按钮的返回进行处理的示例和详解内容[ServerFormDemo详解](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/30-Spigot服Demo详解/6-ServerFormDemo详解.html>)
...
1.Apollo2.0 更新内容
  ...
  1. 更新后，spigot网络服的玩家将使用网易uuid，已上线网络服不受影响，详见[玩家uuid数据存储说明](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/13-1-【必读】玩家uuid数据存储说明.html>)

  2. 增加根据标题显示不同风格的表单界面示例，详见[ServerFormDemo详解](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/30-Spigot服Demo详解/6-ServerFormDemo详解.html>)
...
## 2023.08.10 2.7更新内容
  ...
  1. Apollo 更新内容
     ...
     * 新增开启玩家发包数据统计接口 [EnableNetgamePacketIdStatistics](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#EnableNetgamePacketIdStatistics>)
     * 新增获取玩家发包数量接口 [GetAndClearNetgamePacketIdStatistics](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#GetAndClearNetgamePacketIdStatistics>)
  2. Apollo2.0 更新内容
...
## 2023.05.04 2.6更新内容
  ...
  1. 新增[AddGetPlayerLockTask](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#AddGetPlayerLockTask>)，添加获取玩家在线锁时的处理任务，在所有任务都完成后，才会继续玩家的登录流程
...
service | 2.5.0.release20230406  
  2. Apollo2.0 更新内容
     ...
     * 支持服务端UI，详见[ServerFormDemo详解](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/30-Spigot服Demo详解/6-ServerFormDemo详解.html>)
...
service | 2.5.0.release20230323  
  ...
  2. Apollo2.0 更新内容
     ...
     * 支持了自定义实体，详见[Spigot自定义实体](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/23-Spigot服自定义实体原理简介.html>)
     * proxy与geyser现在合并为一个进程，但部署的配置不变。在部署服务器文档中的[负载-协议转换部分部署流程](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/11-部署服务器.html#负载-协议转换部分部署流程>)调整了相关描述，并且增加了[Proxy与Geyser服的性能参数](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/11-部署服务器.html#proxy与geyser服的性能参数>)的描述
     * 新增[其他部署时可配置字段](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/13-其他部署时可配置字段.html>)文档，讲解命令补全及放置破坏距离的配置
     * SpigotMaster插件、BungeeMaster插件以及示例Demo更改为在McStudio的内容库中下载，详见[下载内容](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/99-下载内容.html>)
...
service | 2.4.0.release20221115  
  ...
  2. 新增[ 服务器部署优化 ](<../../mcguide/27-手机网络游戏/课程8：性能优化/第7节：服务器部署优化.html>)文档
...
service | 2.3.0.release20221018  
  ...
  2. 开服工具2.0正式外放，详情参考[ 支持基岩版客户端的Java版网络游戏概述 ](<../../mcguide/27-手机网络游戏/课程10：使用Spigot开服/10-支持基岩版客户端的Java版网络游戏概述.html>)
...
SpigotMaster插件 | 1.2-SNAPSHOT  
  ...
  3. 修复了[GetPcGameUserLike](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetPcGameUserLike>)接口及文档
...
service | 2.3.0.release20220928  
  ...
  2. 新增插件：属性插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 2.2.0.release20220831  
  ...
  2. 新增插件：战令插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
  3. 新增插件：生物血条插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
  4. 新增插件：空岛插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
## 2022.08.02 2.2更新内容
  ...
  1. 新增插件：定时清理插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 2.2.0.release20220719  
  ...
  3. 新增[ Apollo上使用redis来为mysql进行mem cache的案例 ](<../../mcguide/27-手机网络游戏/课程8：性能优化/第5节：Redis缓存的使用.html>)文档
...
service | 2.1.0.release20220621  
  ...
  2. 新增[GetPcGameUserLike](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetPcGameUserLike>)，获取玩家是否点赞了当前网络服（仅支持PC玩家）
  3. 在服务端使用ListenForEvent监听客户端系统事件时，返回的事件参数现在会自带一个__id__的key表示对应客户端的playerId
  4. 新增插件：成就插件、全息插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 2.1.0.release20220412  
  ...
  2. 新增[ Grafana监控进阶功能 ](<../../mcguide/27-手机网络游戏/课程9：服务器上线/第5节：Grafana监控进阶功能.html>)介绍文档
...
2\. 枚举值新增ContainerType,详见[ContainerType](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/ContainerType.html>) |   
3\. 新增获取附近玩家列表id接口[GetRelevantPlayer](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/行为.html#getrelevantplayer仅apollo可用>) |   
4\. 新增插件：7stars坐骑、自定义分解、自定义合成、排队、第五季节核心, 介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>) |   
  
  1. 新增[GetPlatformUid](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#GetPlatformUid>)，获取玩家登录端的uid，假如玩家从手机端登录，返回手机端的uid，否则返回PC端的uid
  2. 新增[IsPlayerPeUser](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#IsPlayerPeUser>)，获取玩家是否从手机端登录
  3. 新增[GetApolloGameId](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetApolloGameId>)，获取游戏当前项目的gameId（商城查询订单时需要）
  4. 新增[GetApolloGameKey](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetApolloGameKey>)，获取游戏当前项目的gameKey（商城查询订单时需要）
  5. 调整[PlayerLoginServerEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#PlayerLoginServerEvent>)，增加isPeUser字段，区分玩家是从手机端登录还是从PC端登录
  6. 调整[GetPeGameUserStars](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetPeGameUserStars>)，调整实现，仅支持从手机端登录的玩家
  7. 调整[GetUserAuthInfo](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUserAuthInfo>)，调整实现，区分手机端登录玩家和PC端登录玩家
  8. 调整[GetUserGuest](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUserGuest>)，此接口已废弃
  9. 调整[ShareApolloGame](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#ShareApolloGame>)，调整逻辑，仅支持大厅服、游戏服调用，仅支持手机端登录玩家
...
service | 2.0.0.release20220315  
  ...
  2. 事件`MasterResponseTransferFailServerEvent` 添加参数`reason`,详见[MasterResponseTransferFailServerEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/1-大厅与游戏服事件.html#MasterResponseTransferFailServerEvent>)
  3. 新增事件`MasterResponseTransferSucServerEvent`,详见详见[MasterResponseTransferSucServerEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/1-大厅与游戏服事件.html#MasterResponseTransferSucServerEvent>)
  4. 运营指令新增[/netease/update-player-online-limit](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/9-运营指令.html>)，修改全局最高同时在线人数限制。 
  5. 滚动更新文档增加`滚动更新注意事项`,详见[ 部署 ](<../../mcguide/27-手机网络游戏/课程2：Apollo基础知识/第4节：部署.html>)
  6. 反作弊插件迭代，具体参见反作弊插件readme中“1.0.4版本”更新说明 
  7. 新增插件：投票插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 2.0.0.release20220301  
  ...
  3. 新增插件：聊天记录插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  4. 聊天插件迭代，具体参见聊天插件readme中“1.0.7版本”更新说明
  5. 反作弊插件迭代，具体参见反作弊插件readme中“1.0.3版本”更新说明
  6. 新增插件：占位符插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 2.0.0.release20220216  
  ...
  2. 新增滚动更新服务器和滚动关服相关api支持，详见[RollingCloseServersEndEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#RollingCloseServersEndEvent>)，[RollingUpdateServersEndEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#RollingUpdateServersEndEvent>)，[RollingCloseServers](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#RollingCloseServers>)，[RollingUpdateServers](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#RollingUpdateServers>)，滚动更新服务器
  3. 反作弊插件：修正砂轮使用附魔书祛魔可以刷经验的问题
  4. 新增[ 使用ELK查询服务器日志 ](<../../mcguide/27-手机网络游戏/课程9：服务器上线/第10节：使用ELK查询服务器日志.html>)介绍文档
  5. 修复了蜂箱刷生物的问题
...
service | 2.0.0.release20220120  
  ...
  2. 接口[GetUserGuest](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUserGuest>)已废弃，获取启动器中玩家是否游客的信息。
  3. 新增事件[NotifyToMultiClients](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/事件.html#NotifyToMultiClients>)，服务器发送事件到指定一批客户端。
  4. 新增[AniCheatBlockBreak](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AniCheatBlockBreak.html>)，新增反作弊配置枚举值，破坏方块相关。
  5. 新增[AniCheatConsts](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AniCheatConsts.html>)，新增反作弊配置开关宏定义。
  6. 新增[AniCheatMove](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AniCheatMove.html>)，新增反作弊配置枚举值，移动检查开关。
  7. 新增[AniCheatMoveRewind](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AniCheatMoveRewind.html>)，新增反作弊配置枚举值，位移倒带模拟相关参数。
  8. 新增[AniCheatMoveUnSupportRewind](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/AniCheatMoveUnSupportRewind.html>)，新增反作弊配置枚举值，不支持倒带模拟的特殊场景相关参数。
  ...
  14. 新增插件：定时刷新生物方块，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
  15. 新增插件：任务插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 1.25.0.release20220106  
  ...
  3. 新增插件：区块版领地插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  4. 新增插件：地图转存数据库插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  5. 新增插件：小地图插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 1.25.0.release20211223  
  ...
  2. 新增插件：反作弊插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  3. 新增插件：操作记录插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  4. 新增插件：摇号插件、权限插件、禁用物品插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 1.25.0.release20211209  
  ...
  2. 新增[SetShowFakeSeed](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#SetShowFakeSeed>)，在客户端【设置】中，显示虚假的游戏地图种子
  3. 新增[StopShowFakeSeed](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#StopShowFakeSeed>)，在客户端【设置】中，显示真实的游戏地图种子
  4. 修正[ProjectileDoHitEffectEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/实体.html#ProjectileDoHitEffectEvent>)，碰撞到方块时没有触发的问题
  5. 修正[GetModJsonConfigByName](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetModJsonConfigByName>)函数，在控制服中无法正常运行的问题
  6. 新增插件：定期执行运营指令插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  7. 新增插件：货币插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
  8. 新增插件：经验等级插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 1.25.0.release20211125  
  ...
  2. 新增[GetResourceFastload](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#GetResourceFastload>)，获取资源快速加载设置
  3. 新增[SetResourceFastload](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#SetResourceFastload>)，设置资源快速加载
...
service | 1.24.0.release20211111  
  ...
  3. 新增插件：数据转存插件，介绍详见：[官方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/5-官方插件简介.html>)
  4. 新增插件：宝箱礼包插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
  5. 新增离线工具：生成插件模板，下载地址: [生成插件模板工具 (opens new window)](<https://g79.gdl.netease.com/template.zip>)
...
温馨提示，下列说明包含beta版本、稳定版本、开发包体、玩家包体等概念，请注意区分。另外时间节点仅供参考，后续若有调整，将另行通知。 1.25版本开发包外放节点说明：
...
service | 1.24.0.release20211028  
  ...
  2. 新增[ 多版本客户端引擎支持 ](<../../mcguide/27-手机网络游戏/课程9：服务器上线/第7节：多版本客户端引擎支持.html>)介绍文档
  3. 新增[GetProtocolVersionByUID](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetProtocolVersionByUID>)，获取在线玩家客户端协议版本号
  4. 新增[GetServerProtocolVersion](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#GetServerProtocolVersion>)，获取服务器的协议版本号
  5. 升级接口[GetOnlineServerInfoOfMultiPlayers](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetOnlineServerInfoOfMultiPlayers>)，支持获协议版本号
  6. 升级接口[GetOnlineServerInfoOfPlayer](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetOnlineServerInfoOfPlayer>)，支持获协议版本号
...
service | 1.24.0.release20211014  
  ...
  2. 新增[GetApolloUniqueId](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetApolloUniqueId>)，获取游戏当前项目唯一ID
...
service | 1.24.0.release20210916  
  ...
  13. 新增插件：图鉴插件，介绍详见：[第三方插件简介](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)
...
service | 1.23.0.release20210902  
  ...
  * 新增[ 控制台调试 ](<../../mcguide/27-手机网络游戏/课程7：开发技巧/第3节：控制台调试.html>)介绍文档。
  * 补充[ 私钥生成 ](<../../mcguide/27-手机网络游戏/课程1：成为Apollo服主及相关准备/第4节：申请开发阶段服务器.html>)说明文档。
  * 新增[ 快速切服 ](<../../mcguide/27-手机网络游戏/课程8：性能优化/第3节：快速切服.html>)指引文档。
...
温馨提示，下列说明包含beta版本、稳定版本、开发包体、玩家包体等概念，请注意区分。另外时间节点仅供参考，后续若有调整，将另行通知。 1.24版本开发包外放节点说明：
...
service | 1.23.0.release20210819  
  ...
  2. 控制服新增[GetServerLoadedModsById](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetServerLoadedModsById>)，获取服务器加载mods列表
  3. 控制服新增[GetServerLoadedModsByType](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetServerLoadedModsByType>)，获取服务器加载mods列表
  4. 功能服新增[GetServerLoadedModsById](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#GetServerLoadedModsById>)，获取服务器加载mods列表
  5. 功能服新增[GetServerLoadedModsByType](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#GetServerLoadedModsByType>)，获取服务器加载mods列表
...
service | 1.23.0.release20210805  
  ...
  2. 新增4个插件：抽奖，物品栏菜单，背包、箱子整理，随身仓库。介绍详见：[下载地址](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/6-第三方插件简介.html>)

  3. 服务器通信文档中增加[通信接口图示](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#通信接口图示>)，提供通信接口总览

  4. 新增[PlayerCheatSpinAttackServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/玩家.html#PlayerCheatSpinAttackServerEvent>)，触发时机：玩家开始/结束快速旋转攻击并且不符合发送快速旋转攻击条件时触发（装备激流附魔的三叉戟、在水中或雨中，且未骑乘）

  5. 新增[PlayerSpinAttackServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/玩家.html#PlayerSpinAttackServerEvent>)，触发时机：玩家开始/结束快速旋转攻击时触发。

  6. 新增[AddBlockProtectField](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/游戏规则.html#AddBlockProtectField>)，设置一个方块无法被玩家/实体破坏的区域。

  7. 新增[CleanBlockProtectField](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/游戏规则.html#CleanBlockProtectField>)，取消全部已设置的方块无法被玩家/实体破坏的区域。

  8. 新增[RemoveBlockProtectField](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/游戏规则.html#RemoveBlockProtectField>)，取消一个方块无法被玩家/实体破坏的区域。

  9. 新增文档[ 使用数据库前端连接数据库 ](<../../mcguide/27-手机网络游戏/课程1：成为Apollo服主及相关准备/第5节（拓展）：使用数据库前端连接数据库.html>)

  10. 新增文档[ 性能开关 ](<../../mcguide/27-手机网络游戏/课程8：性能优化/第2节：性能开关.html>)
...
service | 1.23.0.release20210722  
  ...
  4. 新增[ResetServer](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#ResetServer>), 功能服重置服务器接口
...
2、[SetPlayerAllItems](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/背包.html#SetPlayerAllItems>)不可以将盔甲、裤子、鞋子设置为空问题修复

3、面对面交易插件迭代，具体参见面对面交易插件readme中“1.0.3版本”更新说明

4、新增[ResetGamesBeginEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#ResetGamesBeginEvent>)，开始重置lobby/game事件

5、新增[ResetGamesEndEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#ResetGamesEndEvent>)，重置lobby/game结束事件

6、新增控制服接口[ResetServer](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#ResetServer>)，重置某个lobby/game

7、新增[GetAllResetingServers](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetAllResetingServers>)，获取所有重置中服务器的id列表

8、新增大厅与游戏服接口[ResetServer](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#ResetServer>)，重置本服务器

9、新增[MasterResponseTransferFailServerEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#MasterResponseTransferFailServerEvent>)，转服失败事件，当玩家试图转服时，没有符合条件的目标服务器时抛出此事件

10、新增[StartChunkProfile](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#StartChunkProfile>)，开始启动服务端区块读写性能分析

11、新增[StopChunkProfile](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#StopChunkProfile>)，结束服务端区块读写性能统计，并返回近期区块读写信息

12、商业化文档补充指令相关说明

13、master重启后，lobby/game通过[RegisterOpCommand](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#RegisterOpCommand>)注册的指令仍生效

14、[SetGameRulesInfoServer](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/游戏规则.html#SetGameRulesInfoServer>)设置command_blocks_enabled对命令矿车生效

15、支持配置game的最大人数，方法：MCStudio打开网络服配置文件目录，在deploy.json文件中game服配置里面添加max_players配置。切服到game时，若超出最大人数限制，则触发[MasterResponseTransferFailServerEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/2-控制服事件.html#MasterResponseTransferFailServerEvent>)事件
...
service | 1.23.0.release20210624  
  ...
  2. 新增[SetKeepResourceWhenTransfer](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#setkeepresourcewhentransfer>)，设置快速切服
  3. 新增[GetKeepResourceWhenTransfer](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#getkeepresourcewhentransfer>)，获取快速切服设置
  4. 新增[/netease/release-online-lock](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/9-运营指令.html>)，强制解除玩家在线标识。
  5. 新增[/netease/release-online-lock-by-server](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/9-运营指令.html>)，强制解除指定ID服务器当前在线玩家的在线标识。
  6. 新增[GetBanUserInfo](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetBanUserInfo>)，获取玩家的封禁信息
  7. 新增[GetUserSilentInfo](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetUserSilentInfo>)，获取玩家的禁言信息
  8. 新增[CraftItemOutputChangeServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/物品.html#craftitemoutputchangeserverevent>)，拿出生成物品时抛出的事件。
...
service | 1.22.0.release20210610  
  ...
  2. 新增[/netease/get-online-uids](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/9-运营指令.html>)，查询当前在线玩家的uid。
  3. 新增[/netease/get-lazy-uids](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/9-运营指令.html>)，查询最近请求登录玩家的uid以及请求登录时间。
  4. 新增[OpenContainerId](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/枚举值/OpenContainerId.html>)，新增开放容器Id的枚举值。
  5. 新增[GetOpenContainerItem](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/方块/容器.html#GetOpenContainerItem>)，获取开放容器的物品。
  6. 新增[CraftItemOutputChangeServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/物品.html#craftitemoutputchangeserverevent>)，拿出生成物品时抛出的事件。
  7. 新增[IsDisableCommandMinecart](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/游戏规则.html#IsDisableCommandMinecart>)，获取当前是否允许运行命令方块矿车内置逻辑指令。
  8. 新增[SetDisableCommandMinecart](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/游戏规则.html#SetDisableCommandMinecart>)，设置停止/开启运行命令方块矿车内置逻辑指令。
  9. 新增[GetUserAuthInfo](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUserAuthInfo>)，获取在线玩家实名制、是否绑定信息。
  10. 新增[CommandBlockContainerOpenEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/方块.html#CommandBlockContainerOpenEvent>)，触发时机：玩家点击命令方块，尝试打开命令方块的设置界面。引擎增加日志【player {} try open commandblock container】
  11. 新增[CommandBlockUpdateEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/方块.html#CommandBlockUpdateEvent>)，触发时机：玩家尝试修改命令方块的内置命令时。引擎增加日志【player {} try to update commandblock content command={}】
...
service | 1.22.0.release20210527  
  ...
  3. 新增文档[ Mod和网络游戏Mod相互转换文档 ](<../../mcguide/27-手机网络游戏/课程2：Apollo基础知识/第7节：Mod和网络游戏Mod相互转换.html>)。
  4. 新增文档[ 多账号协同部署 ](<../../mcguide/27-手机网络游戏/课程7：开发技巧/第2节：多账号协同部署.html>)
  5. 新增[GetServerIdByUid](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetServerIdByUid>)，获取在线玩家所在的服务器的ID。
  6. 新增[NotifyToMaster](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#NotifyToMaster>)，用于service给master发消息。
  7. 新增[RegisterOpCommand(功能服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#RegisterOpCommand>)，用于注册一个新的HTTP接口。
  8. 新增[UnRegisterOpCommand(功能服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#UnRegisterOpCommand>)，用于注销一个已注册的HTTP接口。
  9. 新增[ResponseOpCommandSuccess(功能服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#ResponseOpCommandSuccess>)，用于发送HTTP的成功Response。
  10. 新增[ResponseOpCommandFail(功能服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#ResponseOpCommandFail>)，用于发送HTTP的失败Response。
  11. 新增[RegisterOpCommand(游戏服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#RegisterOpCommand>)，用于注册一个新的HTTP接口。
  12. 新增[UnRegisterOpCommand(游戏服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#UnRegisterOpCommand>)，用于注销一个已注册的HTTP接口。
  13. 新增[ResponseOpCommandSuccess(游戏服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#ResponseOpCommandSuccess>)，用于发送HTTP的成功Response。
  14. 新增[ResponseOpCommandFail(游戏服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#ResponseOpCommandFail>)，用于发送HTTP的失败Response。
  15. 新增[IsGameUnderMaintenance](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#IsGameUnderMaintenance>)，获取游戏是否在维护中。
  16. 新增[GetServerIdsByGameType(控制服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetServerIdsByGameType>)，获取指定类型的服务器id列表。
  17. 新增[GetGameTypeByServerId(控制服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetGameTypeByServerId>)，获取指定ID服务器的类型。
  18. 新增[GetOnlineUidList](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetOnlineUidList>)，获取所有在线玩家的uid列表。
  19. 新增[NotifyToServiceNode(控制服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#NotifyToServiceNode>)，master给某个service发消息。
  20. 新增[NotifyToServiceNode(功能服和游戏服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#notifytoservicenode-2>)，service/lobby/game给某个service发消息。
  21. 新增[BroadcastToService(控制服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#BroadcastToService>)，master给所有service广播消息。
  22. 新增[BroadcastToService(功能服和游戏服)](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#broadcasttoservice-2>)，service/lobby/game给所有service广播消息。
  23. 新增[UnicodeConvert](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#UnicodeConvert>)，递归转换输入数据中的所有unicode格式的字符串为utf-8格式。
  24. 新增[ConvertBsonToInt](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#ConvertBsonToInt>)，递归转换输入数据中的所有bson.int64.Int64类型的对象为int类型。
  25. 修改mongoPool的API说明：[AsyncExecute](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#AsyncExecute>)和[AsyncExecuteWithOrderKey](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#AsyncExecuteWithOrderKey>)。
  26. 公告插件消息支持下拉。
...
service | 1.22.0.release20210513  
  ...
  8. 新增[GetLoadedChunks](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/地图.html#getloadedchunks>)，获取指定维度当前已经加载完毕的全部区块的坐标列表
  9. 新增[GetChunkEntites](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/地图.html#getloadedchunks>)，获取指定位置的区块中，全部的实体和玩家的ID列表
  10. 新增[GetCommandPermissionLevel](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/指令.html#getcommandpermissionlevel>)，返回设定使用/op命令时OP的权限等级
  11. 新增[SetCommandPermissionLevel](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/指令.html#setcommandpermissionlevel>)，设置当玩家使用/op命令时OP的权限等级
  12. 新增[GetDefaultPlayerPermissionLevel](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/指令.html#getdefaultplayerpermissionlevel>)，返回新玩家加入时的权限身份
  13. 新增[SetDefaultPlayerPermissionLevel](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/指令.html#setdefaultplayerpermissionlevel>)，设置新玩家加入时的权限身份
...
service | 1.22.0.release20210429  
  ...
  2. 新增[GetLastFrameTime](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#GetLastFrameTime>)，获取服务端脚本上一帧运行时间
  3. 调整[GetEngineActor](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/实体管理.html#getengineactor>)，返回结果中去掉当前已经确定要移除的实体
  4. 调整[SetCommand](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/指令.html#setcommand>)，当命令执行成功时返回True，否则返回False
  5. 调整[SetPlayerAllItems](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/背包.html#setplayerallitems>)，修正itemDict传入空字典时无法清空盔甲、裤子、鞋子部位装备的问题
  6. 调整[ServerChatEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/世界.html#serverchatevent>)，新增字段，表示被禁言。另外，禁言后，玩家聊天后告知玩家被禁言了
  7. 调整[NotifyToServiceNode](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#NotifyToServiceNode>)，发送的事件信息中自动包含玩家uid
...
service | 1.22.0.release20210415  
  ...
  2. 新增[HidePlayerFootprint](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#HidePlayerFootprint>)，隐藏某个玩家的会员脚印外观。
  3. 新增[HidePlayerMagicCircle](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#HidePlayerMagicCircle>)，隐藏某个玩家的会员法阵外观。
  4. 新增[GetUIDByNickname](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUIDByNickname>)，根据玩家昵称获取玩家uid。
  5. 新增[BanUser](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#BanUser>)，封禁某个玩家。
  6. 新增[UnBanUser](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#UnBanUser>)，解除某个玩家的封禁。
  7. 新增[SilentByUID](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#SilentByUID>)，禁言某个玩家。
  8. 新增[UnSilentByUID](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#UnSilentByUID>)，解除某个玩家的禁言。
...
service | 1.21.0.release20210401  
  ...
  2. 新增[GetApolloReviewStage](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetApolloReviewStage>)，获取游戏当前审核阶段。
  3. 新增[GetServerType](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#GetServerType>)，获取服务器类型。
  4. 新增[GetServerIdsByServerType](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#GetServerIdsByServerType>)，根据类型获取服务器id列表。
  5. 新增[GetOnlineNumByServerType](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#GetOnlineNumByServerType>)，获取某类型服务器的在线人数。
  6. 新增[ApplyUserFriend](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#ApplyUserFriend>)，申请添加为启动器中的好友。
  7. 新增[ShareApolloGame](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#ShareApolloGame>)，在RN上拉起“网络游戏分享”的界面，界面包含游戏ICON以及描述。
  8. 新增[GetUserGuest](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUserGuest>)，获取启动器中玩家是否游客的信息。
  9. 新增[GetPeGameUserStars](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetPeGameUserStars>)，获取玩家对本游戏的评分。
  10. 新增redis集群接口。
  11. 新增随机传送插件。
...
service | 1.21.0.release20210318  
  ...
  2. 新增[GetUserFriend](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUserFriend>)，获取启动器中玩家好友信息。
  3. 新增[GetUsersVIP](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/10-启动器信息API.html#GetUsersVIP>)，获取启动器中玩家会员信息。
...
service | 1.21.0.release20210128  
  ...
  2. 新增[GetModJsonConfigByName](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#GetModJsonConfigByName>)，根据脚本根目录读取mod.json配置文件。
  3. 新增[NotifyToServiceNode](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#NotifyToServiceNode>)，客户端给service服务器发送事件。
...
service | 1.20.0.release20201231  
  ...
  4. [AddServerPlayerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/世界.html#AddServerPlayerEvent>)新增proxyId参数
  5. 新增[RemoteNotifyToClient](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#RemoteNotifyToClient>)，service发送事件到指定客户端。
  6. 新增[SyncInsert](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#SyncInsert>)，阻塞性执行sql语句，插入数据
...
4\. 新增[IsServiceConnected](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#IsServiceConnected>)，检查服务器是否与某个service建立连接。 |   
5\. 新增[BroadcastToServerByType](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/8-服务器通信.html#BroadcastToServerByType>)，service给某种类型服务器广播消息 |   
6\. 调整[ServiceConnectEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/1-大厅与游戏服事件.html#ServiceConnectEvent>)，与service建立连接事件，带一个功能服类型参数 |   
...
6\. 新增[IsInApollo](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/本地存储.html#IsInApollo>)，返回当前游戏Mod是否运行在Apollo网络服，当前版本仅Apollo网络服可用。 |   
...
2\. 新增[SetPlayerRespawnPos](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/行为.html#SetPlayerRespawnPos>)，设置玩家复活的位置，当前玩家的复活点仅支持主世界，当前版本仅Apollo网络服可用 |   
...
service | 1.19.0.release20201022  
  ...
  2. 新增[GetBedColor](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/方块/床.html#GetBedColor>)，获取床（方块）的颜色，仅Apollo网络服可用
  3. 新增[GetSignBlockText](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/方块/告示牌.html#GetSignBlockText>)，获取告示牌（方块）的文本内容，仅Apollo网络服可用
  4. 新增[SetBedColor](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/方块/床.html#SetBedColor>)，设置床（方块）的颜色，仅Apollo网络服可用
  5. 新增[SetSignBlockText](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/方块/告示牌.html#SetSignBlockText>)，设置告示牌（方块）的文本内容，仅Apollo网络服可用
  6. 新增[ChangeEntityDimension](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/属性.html#ChangeEntityDimension>)，传送实体，仅Apollo网络服可用
  7. 新增[ShutdownServer](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#ShutdownServer>)，强制关机
...
service | 1.19.0.release20200929  
  ...
  5. 优化[ChangePerformanceSwitch](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/6-大厅与游戏服API.html#ChangePerformanceSwitch>)，用于提升服务器性能
  6. 新增[EntityChangeDimensionServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/实体.html#EntityChangeDimensionServerEvent>)，实体维度改变时服务端触发
...
service | 1.19.0.release20200917  
  ...
  8. 新增[PlayerLeftMessageServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/世界.html#PlayerLeftMessageServerEvent>)，玩家即将离开时准备显示“xxx离开游戏”时触发事件
  9. 新增[ChangePlayerFlyState](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/行为.html#ChangePlayerFlyState>)，改变玩家的飞行状态
  10. 新增[IsPlayerFlying](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/行为.html#IsPlayerFlying>)，获取玩家是否在飞行
  11. 新增[SetLoginStratege](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/4-控制服API.html#SetLoginStratege>)，支持设置玩家选服策略
...
2\. [AsyncExecuteFunctionWithOrderKey](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#AsyncExecuteFunctionWithOrderKey>)支持mysql事务 |   
...
service | 1.18.0.release20200820  
  ...
  2. 新增[ChangeDatabaseSlowLogLimit](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#ChangeDatabaseSlowLogLimit>)，修改数据库连接池慢请求报警日志限定时间
  3. 新增[CloseAsyncTaskSlowCheck](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#CloseAsyncTaskSlowCheck>)，停止每帧检查异步线程池中的任务
  4. 新增[DumpAsyncTaskPool](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#DumpAsyncTaskPool>)，打印当前异步线程池中的正在排队和执行中的任务信息
  5. 新增[OpenAsyncTaskSlowCheck](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#OpenAsyncTaskSlowCheck>)，启动每帧检查异步线程池中的任务，并且打印执行时间超过指定时间且尚未完成的任务
  6. 新增[StartDatabaseProfile](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#StartDatabaseProfile>)，开始记录数据库连接池请求信息统计
  7. 新增[StopDatabaseMysqlProfile](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#StopDatabaseMysqlProfile>)，停止记录数据库连接池请求信息并输出统计结果
...
service | 1.18.0.release20200806  
  ...
  2. 新增[StartRecordEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#StartRecordEvent>)，开始启动大厅服/游戏服与功能服之间的脚本事件收发包统计
  3. 新增[StopRecordEvent](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/5-功能服API.html#StopRecordEvent>)，停止大厅服/游戏服与功能服之间的脚本事件收发包统计并输出结果
  4. 新增[StartYappiProfile](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#StartYappiProfile>)，开始启动服务端脚本性能分析
  5. 新增[StopYappiProfile](</dev/mcmanual/mc-dev/mcdocs/2-Apollo/4-SDK/7-公共API.html#StopYappiProfile>)，停止服务端脚本性能分析并生成火焰图
  6. 新增[StartRecordEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#StartRecordEvent>)，开始启动服务端与客户端之间的脚本事件收发包统计，当前仅Apollo网络服可用
  7. 新增[StopRecordEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#StopRecordEvent>) ，停止服务端与客户端之间的脚本事件收发包统计并输出结果，当前仅Apollo网络服可用
  8. 新增[StartRecordPacket](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#StartRecordPacket>)，开始启动服务端与客户端之间的引擎收发包统计，当前仅Apollo网络服可用
  9. 新增[StopRecordPacket](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/通用/调试.html#StopRecordPacket>)，停止服务端与客户端之间的引擎收发包统计并输出结果，当前仅Apollo网络服可用
  10. 新增[WillAddEffectServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/实体.html#WillAddEffectServerEvent>)，实体即将获得状态效果
  11. 新增[SetEntityItem](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/背包.html#SetEntityItem>)，支持设置生物身上的物品，当前仅Apollo网络服可用
  12. 新增[GetEntityItem](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/背包.html#GetEntityItem>)，支持获取生物身上的物品，当前仅Apollo网络服可用
  13. 调整[GetEquItemDurability](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/背包.html#GetEquItemDurability>)，新增支持获取生物装备槽位中盔甲的耐久值，当前仅Apollo网络服可用
...
service | 1.18.0.release20200723  
  ...
  2. 新增[ChangeLevelUpCostServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/玩家.html#ChangeLevelUpCostServerEvent>)，获取玩家下一个等级升级经验事件，用于重载玩家的升级经验，每个等级在重置之前都只会触发一次，当前版本仅Apollo网络服可用
  3. 新增[HopperTryPullInServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/方块.html#HopperTryPullInServerEvent>)，漏斗放在容器下方，尝试和容器交互物品时触发
  4. 新增[HopperTryPullOutServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/方块.html#HopperTryPullOutServerEvent>)，漏斗放在容器旁边，尝试往容器加物品时触发
  5. 新增[CreateExperienceOrb](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/实体管理.html#CreateExperienceOrb>)，创建专属经验球
  6. 新增[SetOrbExperience](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/实体/经验球.html#SetOrbExperience>)，修改经验球经验
  7. 新增[UpgradeMapDimensionVersion](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/地图.html#UpgradeMapDimensionVersion>)，提升指定地图维度的版本号，版本号不符的维度，地图存档信息将被废弃，当前版本仅Apollo网络服可用
  8. 新增[GetDroppedItem](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/世界/实体管理.html#GetDroppedItem>)，新增获取掉落在世界的指定entityid的物品信息
  9. 新增[GetPlayerAllItems](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/背包.html#GetPlayerAllItems>)，获取制定槽位的批量物品信息，当前版本仅Apollo网络服可用
  10. 新增[SetPlayerAllItems](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/背包.html#SetPlayerAllItems>)，设置玩家制定槽位物品信息，当前版本仅Apollo网络服可用
  11. 新增[ClearDefinedLevelUpCost](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/玩家.html#ClearDefinedLevelUpCost>)，清理自定义的升级经验，清理后才有会再次回调ChangeLevelUpCostServerEvent事件并再次设置新的升级经验值。当前版本仅Apollo网络服可用
  12. 调整[OnCarriedNewItemChangedServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/物品.html#OnCarriedNewItemChangedServerEvent>)，新增关键字oldItemDict、newItemDict，当前版本仅Apollo网络服可用
  13. 调整[OnNewArmorExchangeServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/物品.html#OnNewArmorExchangeServerEvent>)，新增关键字oldArmorDict、newArmorDict，当前版本仅Apollo网络服可用
  14. 调整[OnOffhandItemChangedServerEvent](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/事件/物品.html#OnOffhandItemChangedServerEvent>)，新增关键字oldItemDict、newItemDict，当前版本仅Apollo网络服可用
...
service | 1.16.0.release20200116  
  ...
  10. 新增OnCarriedNewItemChangedServerEvent事件：右手物品切换的服务端事件
