...
![主文件夹](/dev/mcmanual/mc-dev/assets/img/7.3_main_folder.a3fa48a0.png)
...
![](/dev/mcmanual/mc-dev/assets/img/7.3_main_folder_random.2eaaa80b.png)
...
![](/dev/mcmanual/mc-dev/assets/img/7.3_manifest.e561c6c2.png)
...
![](/dev/mcmanual/mc-dev/assets/img/7.3_block_texture.5d2a8ca4.png)
...
![](/dev/mcmanual/mc-dev/assets/img/7.3_import.e2f7dcbc.png)

然后，我们便可以像往常一样，打开编辑器或者直接进入开发测试进行自测了。

![](/dev/mcmanual/mc-dev/assets/img/7.3_dirt_in-game.bf7eef63.png)
