...
在本节中，我们一起来完成一个挑战，使用方块实体和模组API配合来完成一个自定义箱子。不过，由于我们还没有讲解UI的制作，我们当前阶段先不制作箱子的存储功能。可以点击链接：[箱子Demo (opens new window)](<https://g79.gdl.netease.com/addonguide-customChest.zip>)下载到完整包体。
...
![](/dev/mcmanual/mc-dev/assets/img/13.4_chest_model.3a1ecb59.png)
...
```
![](/dev/mcmanual/mc-dev/assets/img/13.4_large_chest_model.23639ed2.png)
...
![](/dev/mcmanual/mc-dev/assets/img/13.4_large_chest_invert_1.62374966.png)

![](/dev/mcmanual/mc-dev/assets/img/13.4_large_chest_invert_-1.4a5850df.png)

我们希望大箱子的一半的模型具备朝左和朝右两种姿态，这样我们才能将其拼在一起。因此我们制作`invert`动画，其中`variable.mod_invert`在实体定义文件中定义。

![](/dev/mcmanual/mc-dev/assets/img/13.4_chest_open.61dc058b.png)

![](/dev/mcmanual/mc-dev/assets/img/13.4_chest_close.b81bb532.png)

我们希望箱子具备打开和关闭动画，因此制作`open`和`close`动画。

![](/dev/mcmanual/mc-dev/assets/img/13.4_chest_offset.c7972c71.png)

我们知道方块模型必须进行一个(-8, 0, 8)的位移才能正常渲染，因此我们制作`fix_scale`动画。

![](/dev/mcmanual/mc-dev/assets/img/13.4_chest_rotate.07ca9cc2.png)
...
![](/dev/mcmanual/mc-dev/assets/img/13.4_rotate.da62ac96.gif)
...
![](/dev/mcmanual/mc-dev/assets/img/13.4_merge.dbbde47e.gif)
...
![](/dev/mcmanual/mc-dev/assets/img/13.4_open.3b05dd4b.gif)
