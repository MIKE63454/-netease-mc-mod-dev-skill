...
接口 | 所属端 | 用处  
---|---|---  
[`SetBlockEntityModelPosOffset`](<../../../mcdocs/1-ModAPI/接口/方块/渲染.html#setblockentitymodelposoffset>) | **[客户端]** | 设置自定义方块实体的实体模型的位置偏移。  
[`SetBlockEntityModelRotation`](<../../../mcdocs/1-ModAPI/接口/方块/渲染.html#setblockentitymodelrotation>) | **[客户端]** | 设置自定义方块实体的实体模型在各个轴上的旋转。  
[`SetBlockEntityModelScale`](<../../../mcdocs/1-ModAPI/接口/方块/渲染.html#setblockentitymodelscale>) | **[客户端]** | 设置自定义方块实体的实体模型的尺度。  
[`SetEnableBlockEntityAnimations`](<../../../mcdocs/1-ModAPI/接口/方块/渲染.html#setenableblockentityanimations>) | **[客户端]** | 设置是否开启自定义方块实体的动画。  
[`SetBlockEntityMolangValue`](<../../../mcdocs/1-ModAPI/接口/方块/渲染.html#setblockentitymolangvalue>) | **[客户端]** | 设置自定义方块实体的Molang变量的值。  
[`GetBlockEntityMolangValue`](<../../../mcdocs/1-ModAPI/接口/方块/渲染.html#getblockentitymolangvalue>) | **[客户端]** | 获取自定义方块实体的Molang变量的值。  
