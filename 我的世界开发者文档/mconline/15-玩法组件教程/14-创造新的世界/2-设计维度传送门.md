...
```python
    ...
    class Main(ServerSystem):
    	...
    	#end region 构建传送门函数
```
![](/dev/mcmanual/mc-dev/assets/img/15.2_overworld_to_custom_dim.2e74ac47.png)

![](/dev/mcmanual/mc-dev/assets/img/15.2_transfering.7f5d3e95.png)

![](/dev/mcmanual/mc-dev/assets/img/15.2_custom_dim_to_overworld.b43c9e82.png)
