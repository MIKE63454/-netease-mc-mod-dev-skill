...
接下来，我们为我们上一节中添加的盔甲挂接一个模型。所使用的模型可在[3D盔甲资源包 (opens new window)](<https://g79.gdl.netease.com/addonguide-9.zip>)下载。
...
![](/dev/mcmanual/mc-dev/assets/img/9.5_export.561b9a1a.png)

我们通过Blockbench的导出功能将模型的**几何** （**Geometry** ）导出为JSON文件。然后将这个文件和纹理文件一起准备好，将其导入到编辑器中。

![](/dev/mcmanual/mc-dev/assets/img/9.5_import_geo.ae1e2bf0.png)

将几何文件放置在资源包的`models/entity`下。

![](/dev/mcmanual/mc-dev/assets/img/9.5_import_texture.6f1dd4c7.png)
...
![](/dev/mcmanual/mc-dev/assets/img/9.5_t-shirt_in-game.cda93036.png)

![](/dev/mcmanual/mc-dev/assets/img/9.5_t-shirt_preview.b1872cf4.png)
