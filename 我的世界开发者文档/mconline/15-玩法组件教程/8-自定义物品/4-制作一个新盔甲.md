...
![](/dev/mcmanual/mc-dev/assets/img/9.4_armor_create.233c5a34.png)

我们以“**自定义盔甲** ”为基础，这样便可以创建一个盔甲。

![](/dev/mcmanual/mc-dev/assets/img/9.4_armor_created.84d0d05e.png)

我们可以看到，盔甲相比于其他物品，多出了一个盔甲穿戴属性栏。这里便是盔甲的**附着物** （**Attachable** ， _**挂件**_ ）定义的位置。
