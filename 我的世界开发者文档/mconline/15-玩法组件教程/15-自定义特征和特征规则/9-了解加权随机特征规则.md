...
![](/dev/mcmanual/mc-dev/assets/img/16.9_save_structures.8f96871f.png)
...
```
![](/dev/mcmanual/mc-dev/assets/img/16.9_in-game_1.c3c0e6d3.png)

我们可以看到，水井特征如期生成了。

![](/dev/mcmanual/mc-dev/assets/img/16.9_in-game_2.6dc7d8f1.png)
