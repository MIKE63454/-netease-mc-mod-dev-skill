...
![召唤尸壳](/dev/mcmanual/mc-dev/assets/img/4.6_husk.66ccf2ab.png)
...
![命名牌](/dev/mcmanual/mc-dev/assets/img/4.6_nametag_renaming.9e7ce4a4.png)

![尸壳命名](/dev/mcmanual/mc-dev/assets/img/4.6_named_husk.8c99a78e.png)
...
```
![summon_rider](/dev/mcmanual/mc-dev/assets/img/4.6_ride_summon_rider.e3ff4603.png)

可以看到，我们使用了`@e`选择器配合`name`参数精确指定到了该实体。执行成功后，我们可以看到这个尸壳头上已经出现了一个新的尸壳。

![两个尸壳](/dev/mcmanual/mc-dev/assets/img/4.6_husk_with_rider.fbd3412a.png)
...
```
![summon_ride](/dev/mcmanual/mc-dev/assets/img/4.6_ride_summon_ride.fa69eeee.png)

成功之后，我们看到了三个尸壳坐在一起，颇有叠高高的风味。

![三个尸壳](/dev/mcmanual/mc-dev/assets/img/4.6_husk_with_rider_and_ride.950e98eb.png)
