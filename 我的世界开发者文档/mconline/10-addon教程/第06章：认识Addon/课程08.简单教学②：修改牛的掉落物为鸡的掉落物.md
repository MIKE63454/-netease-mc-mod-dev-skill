...
![](/dev/mcmanual/mc-dev/assets/img/8_1.325675fb.png)
```python
    {
...
```
![](/dev/mcmanual/mc-dev/assets/img/8_2.49f22916.png)
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/8_1.325675fb.png
