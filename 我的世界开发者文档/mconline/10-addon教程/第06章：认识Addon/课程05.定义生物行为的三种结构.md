...
![](/dev/mcmanual/mc-dev/assets/img/5_1.e886f00f.png)
```python
    {
...
![](/dev/mcmanual/mc-dev/assets/img/5_2.c692df71.png)
```python
    {
        "format_version":"1.16.0",
        "minecraft:entity":{
...
![](/dev/mcmanual/mc-dev/assets/img/5_3.df029006.png)
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/5_1.e886f00f.png
