...
![](/dev/mcmanual/mc-dev/assets/img/1_1.48802b15.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_2.7c05f042.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_3.e7e2094b.jpg)

①监听ItemReleaseUsingServerEvent事件

②根据蓄力的时间，由开发者决定根据时间的长短来划分箭的伤害，以达到模拟出原版弓箭发射时的动态伤害效果。

![](/dev/mcmanual/mc-dev/assets/img/1_4.67171ffd.jpg)
