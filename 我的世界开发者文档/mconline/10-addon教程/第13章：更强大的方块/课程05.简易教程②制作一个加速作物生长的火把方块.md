...
加速火把示例包下载：下载[示例包 (opens new window)](<https://g79.gdl.netease.com/guidedemo-case13.zip>) 。

#### 火把方块示意图：

![5_1](/dev/mcmanual/mc-dev/assets/img/5_1.7dd7a26c.jpg)

#### 增加火把方块行为包

![](/dev/mcmanual/mc-dev/assets/img/5_2.d029d67b.jpg)
```python
    {
...
![](/dev/mcmanual/mc-dev/assets/img/5_3.a6bcccdd.jpg)
```python
    {
        "format_version": "1.16.0",
        "minecraft:block": {
...
![](/dev/mcmanual/mc-dev/assets/img/5_4.e5d3a911.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/5_5.d0bc082b.jpg)

https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/5_5.d0bc082b.jpg
