...
挂载苹果示例包下载：下载[示例包 (opens new window)](<https://g79.gdl.netease.com/guidedemo-case13.zip>) 。

#### 增加苹果方块

![](/dev/mcmanual/mc-dev/assets/img/4_1.3a9e7264.jpg)

#### 实现代码逻辑如下：

![](/dev/mcmanual/mc-dev/assets/img/4_2.42828c7b.jpg)
```python
    {
...
![](/dev/mcmanual/mc-dev/assets/img/4_3.406ca795.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/4_4.982ce7c0.jpg)
```python
    {
...
```
![](/dev/mcmanual/mc-dev/assets/img/4_5.aee14589.jpg)
```python
    {
        "format_version": [
          1,
...
![](/dev/mcmanual/mc-dev/assets/img/4_6.6e652efa.jpg)
```python
    {
      "format_version": "1.14.0",
      "minecraft:single_block_feature": {
...
![](/dev/mcmanual/mc-dev/assets/img/4_7.2052f98d.jpg)
...
```
![](/dev/mcmanual/mc-dev/assets/img/4_8.88f34ee1.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/4_9.f951edf4.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/4_10.f2c5d857.jpg)

https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/4_10.f2c5d857.jpg
