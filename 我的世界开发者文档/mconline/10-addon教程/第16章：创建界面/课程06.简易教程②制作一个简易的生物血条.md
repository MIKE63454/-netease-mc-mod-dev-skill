...
生物血条示例包下载：下载[示例包 (opens new window)](<https://g79.gdl.netease.com/guidedemo-case16.zip>) 。
...
![](/dev/mcmanual/mc-dev/assets/img/6_1.67d4a73b.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/6_2.8c741d0b.jpg)

![](/dev/mcmanual/mc-dev/assets/img/6_3.56407fca.jpg)

而在客户端系统上，我们通过在UiInitFinish事件里，添加一个实例变量来确保从这之后开始，在AddEntityClientEvent事件里才能为其他实体生物绑定UI。在RemoveEntityClientEvent里移除UI。

https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/6_1.67d4a73b.jpg
