...
![](/dev/mcmanual/mc-dev/assets/img/3_2.b42d2023.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/3_1.7d892d10.jpg)

⑤使用客户端的PushScreen接口，第一个参数即UI的命名空间，第二个参数即UI名称，分别对应注册UI的前两个参数。进入游戏后，查看效果。

https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/3_1.7d892d10.jpg
