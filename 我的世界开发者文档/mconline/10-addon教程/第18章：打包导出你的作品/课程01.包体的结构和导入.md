...
![](/dev/mcmanual/mc-dev/assets/img/1_8.a0c702db.jpg)

  1. 上传平台的MOD文件必须以jar格式作为分发给玩家游玩的标准文件格式。

![](/dev/mcmanual/mc-dev/assets/img/1_9.dd7028ea.jpg)

  2. 打开MCSTUDIO，点击作品库后再点击Java版组件。在右上角点击本地导入，【作品分区】选择Java版作品。【作品分类】中选择Mod。【适用MC版本】选择对应存档本版。若支持多个版本可以选择多个相应版本。

![](/dev/mcmanual/mc-dev/assets/img/1_10.64a10b20.jpg)

3）点击导入窗体内的+号按钮，直接双击或选择jar文件后选打开。

![](/dev/mcmanual/mc-dev/assets/img/1_11.a5cdc1cc.jpg)

  4. 最后点击导入按钮，即可由MCSTUDIO拷贝作品后导入进作品库内，进行后续的测试、发布、配置等操作。若开发者选择删除作品，也不会影响到最原先的jar文件。

![](/dev/mcmanual/mc-dev/assets/img/1_12.65605ae2.jpg) ![](/dev/mcmanual/mc-dev/assets/img/1_13.ced1731e.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_14.70a3350c.jpg)

  1. 截图主要展示JAVA版材质的目录和文件结构。

![](/dev/mcmanual/mc-dev/assets/img/1_15.5fe1e876.jpg)

  2. 直接将材质文件夹内的内容全部选取后右键保存成zip压缩文档。

![](/dev/mcmanual/mc-dev/assets/img/1_16.eb8ce3b7.jpg)

  3. 打开MCSTUDIO，点击作品库后再点击Java版组件。在右上角点击本地导入，【作品分区】选择Java版作品。【作品分类】中选择材质。【适用MC版本】选择对应存档本版。若支持多个版本可以选择多个相应版本。

![](/dev/mcmanual/mc-dev/assets/img/1_17.6e23671a.jpg)

  4. 点击导入窗体内的+号按钮，直接双击或选择zip文档后选打开。

![](/dev/mcmanual/mc-dev/assets/img/1_18.0b6bfab2.jpg)

  5. 最后点击导入按钮，即可由MCSTUDIO拷贝作品后导入进作品库内，进行后续的测试、发布、配置等操作。若开发者选择删除作品，也不会影响到最原先的材质压缩档。

![](/dev/mcmanual/mc-dev/assets/img/1_19.a7aa0411.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_20.2a55b107.jpg)

  1. 截图主要展示JAVA版光影的内容目录和文件结构。

![](/dev/mcmanual/mc-dev/assets/img/1_21.c9bb3d5b.jpg)

  2. 直接将文件夹内的所有文件全部选取后右键保存成zip压缩文档。

![](/dev/mcmanual/mc-dev/assets/img/1_22.ba0ec87e.jpg)

  3. 打开MCSTUDIO，点击作品库后再点击Java版组件。在右上角点击本地导入，【作品分区】选择Java版作品。【作品分类】中选择光影。【适用MC版本】选择对应存档本版。若支持多个版本可以选择多个相应版本。

![](/dev/mcmanual/mc-dev/assets/img/1_23.10b919f8.jpg)

  4. 点击导入窗体内的+号按钮，直接双击或选择zip文档后选打开。

![](/dev/mcmanual/mc-dev/assets/img/1_24.20a62193.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_25.d98dea60.jpg)

  1. 截图主要展示PC皮肤资源支持的文件格式，为结尾png的图片文档。该格式的图片保存着一道透明通道。

![](/dev/mcmanual/mc-dev/assets/img/1_26.39cc578a.jpg)

  2. 打开MCSTUDIO，点击作品库后再点击Java版组件。在右上角点击本地导入，【作品分区】选择Java版作品。【作品分类】中选择皮肤。【适用MC版本】选择默认选择全版本即可。

![](/dev/mcmanual/mc-dev/assets/img/1_27.ce877d52.jpg)

  3. 点击导入窗体内的+号按钮，直接双击或选择png文档后选打开。

![](/dev/mcmanual/mc-dev/assets/img/1_28.bca47fa1.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_29.10b0b630.jpg)

  1. 截图截选了我的世界JAVA版1.12.2游戏客户端生成的地图的内容。test文件夹下存放着名为test的世界信息。命令方块玩法、数据包等是用我的世界JAVA版地图作为承载。

![](/dev/mcmanual/mc-dev/assets/img/1_30.2ebb717c.jpg)

  2. 打开这个客户端可以看到test存档。

![](/dev/mcmanual/mc-dev/assets/img/1_31.b5c459c9.jpg)

  3. 返回到目录的上一级，saves文件夹下则会存放着这个客户端可以启动的所有存档文件夹，其中就有前面提到的test存档。

![](/dev/mcmanual/mc-dev/assets/img/1_32.cfa209cc.jpg)

  4. 打开MCSTUDIO，点击作品库后再点击Java版组件。在右上角点击本地导入，【作品分区】选择Java版作品。【作品分类】中选择玩法。【适用MC版本】选择对应存档本版。若支持多个版本可以选择多个相应版本。

![](/dev/mcmanual/mc-dev/assets/img/1_33.c77ca47e.jpg)

  5. 点击导入窗体内的+号按钮，直接选择test文件夹后点击选择文件夹。

![](/dev/mcmanual/mc-dev/assets/img/1_34.902674c3.jpg)

  6. 最后点击导入按钮，即可由MCSTUDIO拷贝作品后导入进作品库内，进行后续的测试、发布、配置等操作。若开发者选择删除作品，也不会影响到最原先的存档文件夹。

![](/dev/mcmanual/mc-dev/assets/img/1_35.5cf40cf5.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_36.84f23528.jpg)

  1. 截图截选了我的世界基岩版1.16.12游戏客户端生成的世界存档的内容。英文数字组合名称的文件夹下存放着该存档的世界信息。

![](/dev/mcmanual/mc-dev/assets/img/1_38.9796fa7c.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_37.290adc6d.jpg)

  3. 勾选选项时，点击窗体内的+号。不勾选选项时，点击窗体内的选择按钮。双击存档文件夹或选择文件夹后点击【选择文件夹】按钮。

![](/dev/mcmanual/mc-dev/assets/img/1_39.18ca906c.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_40.07184b83.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_41.c38125e2.jpg)

  1. 截图截选了我的世界基岩版1.16.12游戏客户端生成的世界存档的内容。英文数字组合名称的文件夹下存放着该存档的世界信息。联机地图指代可以同时在本地、本地联机、联机大厅上使用的地图资源。

![](/dev/mcmanual/mc-dev/assets/img/1_42.aa6b4587.jpg) ![](/dev/mcmanual/mc-dev/assets/img/1_43.1230cfe3.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_45.24dbed23.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_46.74490621.jpg) ![](/dev/mcmanual/mc-dev/assets/img/1_47.de3eafe7.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_48.62a10c94.jpg)

  1. 附加包是行为包和材质包的统称，因此材质包被算入附加包的一种类型。因此开发者在上架完整的材质包内容前，需依照接下来的规范进行打包上传。请注意：上架至中国版平台的材质包内必须携带textures文件夹。

![](/dev/mcmanual/mc-dev/assets/img/1_49.521ac154.jpg) ![](/dev/mcmanual/mc-dev/assets/img/1_50.4e41c3a5.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_51.d668bbf2.jpg)

  1. 光影的内容都被保存在材质包文件夹中，因此在运行机制与打包机制上与材质包类似。因此开发者在上架完整的光影内容前，需依照接下来的规范进行打包上传。请注意：上架至中国版平台的材质包内必须携带textures文件夹。

![](/dev/mcmanual/mc-dev/assets/img/1_52.464c7ec9.jpg) ![](/dev/mcmanual/mc-dev/assets/img/1_53.dacdbdba.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/1_54.7778305b.jpg)

  1. 截图主要展示PE皮肤资源支持的文件格式，为结尾png的图片文档。该格式的图片保存着一道透明通道。

![](/dev/mcmanual/mc-dev/assets/img/1_55.a1e2706a.jpg)
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/1_1.dc5d5f44.jpg
