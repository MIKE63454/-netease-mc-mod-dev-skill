...
![](/dev/mcmanual/mc-dev/assets/img/3_1.ea877fdd.jpg)
...
```
random_block_state：随机选取一个block state值，当设置的物品为方块物品且含有该值的话，如 "coral_color", "flower_type", "sapling_type"，更多blockstate请参考[官方文档 (opens new window)](<https://learn.microsoft.com/en-us/minecraft/creator/reference/content/blockreference/examples/intrinsicblockstateslist?view=minecraft-bedrock-stable>)。
```python
    {
