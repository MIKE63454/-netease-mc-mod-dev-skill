...
现在，已经基本具备海滨小岛的内容，不过还缺乏生机，岛上只有玩家自己是不行的，所以让我们来给小岛上添加各种各样的NPC吧。在添加NPC前，需要了解什么是[自定义生物](</dev/mcmanual/mc-dev/mconline/10-addon教程/第07章：自定义生物/课程01.认识自定义生物.html>)，当我们创建一个基本的自定义生物后，就该把它变换一个“形态”，让其成为可以闲逛、交易、且生机勃勃的海滨岛民。

![0](/dev/mcmanual/mc-dev/assets/img/0.955b51fa.png)
