...
![8](/dev/mcmanual/mc-dev/assets/img/8.5d31a4dd.png)
...
![9](/dev/mcmanual/mc-dev/assets/img/9.51dfeb28.png)
...
有关components、events与component_groups三者之间的关系，可以参考往期教程：[定义生物行为的三种结构 (opens new window)](<https://g.126.fm/04a9tkE>)。
...
![10](/dev/mcmanual/mc-dev/assets/img/10.85b55bd4.gif)
