...
![11](/dev/mcmanual/mc-dev/assets/img/11.dc1cc9dd.gif)
...
```python
    ...
    def clicked_close_button(self,args):
        ...
        clientApi.PopScreen()
```
![26](/dev/mcmanual/mc-dev/assets/img/26.9290a33e.gif)
...
![35](/dev/mcmanual/mc-dev/assets/img/35.44eb84ae.gif)
...
![41](/dev/mcmanual/mc-dev/assets/img/41.1728a085.gif)
