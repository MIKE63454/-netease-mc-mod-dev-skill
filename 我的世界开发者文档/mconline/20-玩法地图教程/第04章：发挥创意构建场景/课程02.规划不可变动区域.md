...
![2](/dev/mcmanual/mc-dev/assets/img/2.92c1e4a0.png)

可以直接拖拉文件图标至编辑器页面内，编辑器将自动吞入并打开。简单输入其中一个指令，后续的参数就会智能提示并按enter或tab键自动补全。

![](/dev/mcmanual/mc-dev/assets/img/3.ab573993.gif)
...
![4](/dev/mcmanual/mc-dev/assets/img/4.365425a3.png)
...
![4](/dev/mcmanual/mc-dev/assets/img/4.69087d05.gif)
...
![8](/dev/mcmanual/mc-dev/assets/img/8.e48cf5c2.png)

接着点选地面，并拖动Y轴将选格向上提升一格。

![9](/dev/mcmanual/mc-dev/assets/img/9.0547dff2.png)

选择填充功能，对格子内的区域进行箱子方块填充。

![10](/dev/mcmanual/mc-dev/assets/img/10.b271ebeb.png)
...
![6](/dev/mcmanual/mc-dev/assets/img/6.0d8e2149.png)

点选房梁与房顶间的空隙，并逐个往上拖。

![5](/dev/mcmanual/mc-dev/assets/img/5.29a585e6.gif)

最后用灯作为材质预设，并选择填充功能对选取的区域进行统一填充。

![6](/dev/mcmanual/mc-dev/assets/img/6.a91a88da.gif)

由于基岩版存在部分方块是需要用物品才能放置出来的。当前地图编辑器暂未支持放置物品与方块处于分离状态的方块类型。我们通过点击地图编辑器右上方的**游戏模式** 退出自由摄像状态，就能够打开背包并在世界里直接放置方块。这里以放置一张床为例：

![7](/dev/mcmanual/mc-dev/assets/img/7.f23cfa3c.gif)
