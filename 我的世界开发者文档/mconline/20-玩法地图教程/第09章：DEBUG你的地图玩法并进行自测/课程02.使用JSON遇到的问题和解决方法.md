...
![4](/dev/mcmanual/mc-dev/assets/img/4.daadad8c.png)

一些在线的JSON格式校验网站也可以检测格式，非常方便：

![7](/dev/mcmanual/mc-dev/assets/img/7.a6239028.png)

其次就是在进入游戏时会弹出的报错窗口：

![5](/dev/mcmanual/mc-dev/assets/img/5.c5711015.png)

json的报错同样会带有一些问题的提示信息：“节点分析失败：netease_solit”，我们可以根据报错的信息找到问题所在；并且，json的报错一般都不只有一个，比如这个报错点击确定后还会再弹出一个新的报错：

![6](/dev/mcmanual/mc-dev/assets/img/6.7c1333f2.png)
