...
NPC交易相关的教程内容在[第五章](</dev/mcmanual/mc-dev/mconline/20-玩法地图教程/第05章：设置NPC的基本状态和交易表/课程01.自定义NPC的基本行为.html>)
```python
    leveldatacomp = serverApi.GetEngineCompFactory().CreateExtraData(serverApi.GetLevelId())
    class FarmServerSystem(ServerSystem):
    	def __init__(self, namespace, systemName):
...
```
https://nie.res.netease.com/r/pic/20220408/0c3f2c46-fb70-4102-820b-3ed513469dc5.png
