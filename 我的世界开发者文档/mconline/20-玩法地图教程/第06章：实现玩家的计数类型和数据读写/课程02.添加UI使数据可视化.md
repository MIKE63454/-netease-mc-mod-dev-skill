...
![1](/dev/mcmanual/mc-dev/assets/img/1.9008203f.png)

接下来在背景下分别创建显示钱数、天数和家具数量的图片和文字并修改至合适的位置：

![2](/dev/mcmanual/mc-dev/assets/img/2.32cd3b1c.png)
...
![3](/dev/mcmanual/mc-dev/assets/img/3.886afc85.gif)
...
![4](/dev/mcmanual/mc-dev/assets/img/4.bbc2520a.gif)

通过交易表购买商品：

![5](/dev/mcmanual/mc-dev/assets/img/5.8b8bb4d4.gif)

摆放和破坏家具：

![6](/dev/mcmanual/mc-dev/assets/img/6.706742a4.gif)
