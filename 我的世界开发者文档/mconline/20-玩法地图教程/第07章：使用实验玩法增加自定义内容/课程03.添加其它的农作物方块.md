...
![18](/dev/mcmanual/mc-dev/assets/img/18.53d290df.gif)
...
![19](/dev/mcmanual/mc-dev/assets/img/19.6c53c9c9.png)
...
```
![20](/dev/mcmanual/mc-dev/assets/img/20.96c82452.gif)
...
```
![21](/dev/mcmanual/mc-dev/assets/img/21.b8f90e7f.gif)
...
```
![22](/dev/mcmanual/mc-dev/assets/img/22.1441cba6.gif)
        ...
        def use_bone_meal(self, event):
            ...
            if playerid not in self.interact_cooldown:
                ...
                if time.time() - self.interact_cooldown[playerid] > 0.5:
                    ...
                    pass
```
![23](/dev/mcmanual/mc-dev/assets/img/23.a8d1d55c.gif)
