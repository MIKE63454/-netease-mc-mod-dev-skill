...
![40](/dev/mcmanual/mc-dev/assets/img/40.1d5cd6e3.png)
...
![41](/dev/mcmanual/mc-dev/assets/img/41.22adabfa.png)

![42](/dev/mcmanual/mc-dev/assets/img/42.d14987df.png)

装备模型和原版史蒂夫模型的很多组名（Group）都一样，这个牛仔裤模型的块都在leftLeg和rightLeg下，分别对应左腿和右腿，这里的组名就是和史蒂夫绑定的骨骼；

如果我们把rightleg的组名随意修改会发生什么？

![43](/dev/mcmanual/mc-dev/assets/img/43.70383cf3.gif)
