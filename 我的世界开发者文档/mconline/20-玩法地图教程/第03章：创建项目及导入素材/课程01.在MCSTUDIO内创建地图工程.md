...
![0](/dev/mcmanual/mc-dev/assets/img/0.85ec892c.jpg)

在未来，新版编辑器将多方位覆盖开发者的日常开发流程。我们推荐您将地图作品升级成新版格式，提前体验新版编辑器的魅力。

![1](/dev/mcmanual/mc-dev/assets/img/1.eee42752.jpg)
...
您必须使用相关的地图处理工具去处理地图。这里推荐使用[chunker (opens new window)](<https://chunker.app/>)对地图进行NBT修改。NBT在基岩版中同样存在，并且在地图文件里会管理地图的一些基本设定。在将地图上传成功后，请选择右下角的Advance Settings，接着选择WORLD SETTINGS，手动关闭**Multiplayer Game Enabled** 、**Visible to Multiplayer** 、**LAN Broadcast Enabled** 、**Visible to LAN Players** 等开关。

![6](/dev/mcmanual/mc-dev/assets/img/6.a470bf07.png)

我们同样需要关掉**Do Insomnia** 、**Do Mob Spawning** 与**TNT Explodes** ，这样可以避免玩家在地图里遇到TNT爆炸、自然生物生成和幻翼的干扰。

![17](/dev/mcmanual/mc-dev/assets/img/17.3c8f8643.png)
...
![18](/dev/mcmanual/mc-dev/assets/img/18.4102e6c6.png)
