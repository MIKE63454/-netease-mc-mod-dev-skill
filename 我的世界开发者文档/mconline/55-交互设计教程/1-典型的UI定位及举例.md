...
![img](/dev/mcmanual/mc-dev/assets/img/1_1.b9f98200.png)

### 装备耐久度

直观反映装备的耐久数值，原版仅用类似进度条的方法显示，有开发者通过获取装备耐久值显示在屏幕的其他位置更加直观的展示了装备的具体耐久度数值。

![img](/dev/mcmanual/mc-dev/assets/img/1_2.f0f219c2.png)

### 小地图

这个属于模组内容，可以帮助玩家更好的探索世界，通过小地图玩家可以更加直观的知道自己所处的位置，方便玩家进行探索。

![img](/dev/mcmanual/mc-dev/assets/img/1_3.9d50fb86.png)
...
![img](/dev/mcmanual/mc-dev/assets/img/1_4.dd7e4aaa.png)

### 组件一级按钮

操作按键，需要玩家大量的点击进行人物控制，同时玩家也可以根据按键反馈来判断人物当前的状态，部分模组也是用了按钮UI来释放技能，让玩家更加方便操作

![img](/dev/mcmanual/mc-dev/assets/img/1_5.d81fab17.png)
...
![img](/dev/mcmanual/mc-dev/assets/img/1_6.07ff6033.png)

### 背包按钮

背包也是点击快捷物品栏旁的按钮后进入背包，打开背包UI时玩家不可操作游戏角色，以便进入背包模式后玩家可以更加方便和专注的调整背包内物品

![img](/dev/mcmanual/mc-dev/assets/img/1_7.304212d6.png)