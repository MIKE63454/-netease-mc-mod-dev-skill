...
利用[插件编写——制作篇(中)](</dev/mcmanual/mc-dev/mconline/30-网络服插件教程/4-插件制作/5-插件编写——制作篇（中）.html#代码下载>)和[插件编写——制作篇(下)](</dev/mcmanual/mc-dev/mconline/30-网络服插件教程/4-插件制作/6-插件编写——制作篇（下）.html#代码下载>)下载的插件代码，可跟着教程一同部署并测试。
...
部署过程在之前已经讲过，忘记了的可以[点我](</dev/mcmanual/mc-dev/mconline/30-网络服插件教程/2-初识插件/2-应用插件.html>)进行回顾。
...
![](/dev/mcmanual/mc-dev/assets/img/code-9.f700dd62.png)

聊天框输入cp2 查看已领取的号码

![](/dev/mcmanual/mc-dev/assets/img/code-10.5c76cdf2.png)
...
![](/dev/mcmanual/mc-dev/assets/img/code-11.877be31e.png)
...
![](/dev/mcmanual/mc-dev/assets/img/code-14.28d8261a.png)
...
```
![](/dev/mcmanual/mc-dev/assets/img/code-12.6836d4b4.png)

#### 原生指令

原生指令即Minecraft自带的指令，可以执行op,gamemode等类似指令。

![](/dev/mcmanual/mc-dev/assets/img/code-15.8426d92a.png)

#### Post指令

Post指令即Master服务器提供的HTTP指令。可以在面板中选择或输入你需要执行的指令，例如查看在线玩家列表。

![](/dev/mcmanual/mc-dev/assets/img/code-13.3158a672.png)