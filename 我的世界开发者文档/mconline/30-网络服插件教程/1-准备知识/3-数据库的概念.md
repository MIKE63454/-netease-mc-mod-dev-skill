...
![](/dev/mcmanual/mc-dev/assets/img/mysql-1.90660c5d.png)
...
![](/dev/mcmanual/mc-dev/assets/img/mysql-2.5262120b.png)
...
![](/dev/mcmanual/mc-dev/assets/img/navicat-1.ce190e01.png)

  2. 在“常规”标签页下，输入连接名(任意，用于区分连接)，用户名 _minecraft_ ，密码 _minecraft_ (以上均为默认密码)。

![](/dev/mcmanual/mc-dev/assets/img/navicat-2.cad099b1.png)

  3. 在“SSH”标签页下，勾选使用SSH隧道，填写主机，端口 _32200_ ，用户名 _fuzhu_ ，验证方法 _公钥_ ，选择私钥路径。通行短语输入你创建RSA密钥时输入的密码。勾选保存通行短语并保存。

![](/dev/mcmanual/mc-dev/assets/img/navicat-3.9129b2f9.png)

  4. 随后可在左边区域看到你新建的连接，双击即可进行连接。

![](/dev/mcmanual/mc-dev/assets/img/navicat-4.ca23d9e2.png)