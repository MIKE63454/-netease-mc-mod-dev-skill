...
首先下载素材包 [链接 (opens new window)](<https://x19.gdl.netease.com/demo.zip>)。并解压到一个文件夹中。

然后新建一个空白附加包，切换到特效编辑器，点击导入模型按钮。

![](/dev/mcmanual/mc-dev/assets/img/16.5a9b4842.png)

选择文件夹`./demo/fbx/datiangou`

![](/dev/mcmanual/mc-dev/assets/img/17.4b4b5dfb.png)

弹出的界面直接确定即可。

随后切换模型到datiangou，就可以看到导入的模型了。

![](/dev/mcmanual/mc-dev/assets/img/18.128f3dd2.png)

现在开始制作序列帧效果。

在资源管理中，找到`effects(网易版特效)`，点击加号进行新建，名称填写`snow`

![](/dev/mcmanual/mc-dev/assets/img/19.f958b8aa.png)

然后将demo文件夹中的sfx中的内容，复制到当前组件的`resource_pack/textures/sfxs`文件夹中

![](/dev/mcmanual/mc-dev/assets/img/20.f85d078c.png)

在右侧属性窗口，将贴图替换为刚刚复制的图片

![](/dev/mcmanual/mc-dev/assets/img/21.92a074f8.png)
...
![](/dev/mcmanual/mc-dev/assets/img/22.70891eb2.gif)
