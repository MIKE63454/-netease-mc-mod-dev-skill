...
你可以通过[开发者平台  (opens new window)](<https://mcdev.webapp.163.com/#/square>)顶部的开发者常见问题答疑的反馈其他问题进行反馈，也可直接点击[这个链接 (opens new window)](<https://mcdev.webapp.163.com/#/feedbackModal>)。官方将通过开发者平台站内信与您取得联系。
