...
TabooLib 内置了专属的反射依赖库 <https://github.com/TabooLib/reflex>[ (opens new window)](<https://github.com/TabooLib/reflex>) Reflex 为基于 Kotlin 语言开发的反射工具，其与 Java 原生反射 API 及 kotlin-reflect 间最大区别在于其可无视软兼容反射目标类中的字段或方法。 你无需了解这么多 只需要看看有没有遇到这种情况：
