...
![image-20210823120000970](/dev/mcmanual/mc-dev/assets/img/image-20210823120000970.5ef2cc29.png)

点击“导出”按钮后，会弹出“导出为资源包” 界面， 在该界面，您可以选择相应的文件，然后点击“导出”按钮进行导出。

![image-20210823140555212](/dev/mcmanual/mc-dev/assets/img/image-20210823140555212.aee55b8e.png)

点击“导出”按钮后，选择对应的文件路径进行保存为资源包（mep文件），一个资源包就成功导出了。

![image-20210823140842423](/dev/mcmanual/mc-dev/assets/img/image-20210823140842423.bba760e8.png)
...
![image-20210823143920438](/dev/mcmanual/mc-dev/assets/img/image-20210823143920438.b3d02aaf.png)

在弹出的文件选择框中选择你需要的资源包（mep格式），即可导入对应内容。

![image-20210823144250187](/dev/mcmanual/mc-dev/assets/img/image-20210823144250187.5936e2b1.png)

## 内容库资源包导入

您可以直接打开内容库的资源包分页，选择你需要的作品并下载，此时点击该作品卡片上的导入按钮，即可将其一键导入到当前编辑器所打开的作品中，详情可参考[内容库文档](</dev/mcmanual/mc-dev/mcguide/15-资源管理/11-内容库.html#导入资源>)。

![image-20210823144250187](/dev/mcmanual/mc-dev/assets/img/importcontentlib.1ad03eec.png)
...
https://nie.res.netease.com/r/pic/20220408/8607da19-6e64-4f3e-bbaf-2432573d305b.png
