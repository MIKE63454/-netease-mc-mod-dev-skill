...
当前官方提供的“多关节”结构Blockbench模型已经能满足大部分的模组开发者
  ...
  * 请开发者下载[官方规范player模型文件 (opens new window)](<https://g79.gdl.netease.com/official_steve_model.zip>)
...
## 规范概要
  ...
  * 如需修改修改bb结构，则应该按以下优先级进行美术制作 
    ...
    * **按规范** 砍四肢与body为多关节模型
    * **按规范** 命名骨骼/层级，但是玩家骨骼层级随意修改 _（极不推荐）_
  ...
  * 其余情况开发者也可以使用接口判断更换模型的必要性 
    * [IsOfficialSkin](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/属性.html#isofficialskin>) —— 获取玩家穿戴的皮肤是否为官方4d皮肤
    * [IsMultiJointOfficialSkin](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/属性.html#ismultijointofficialskin>) —— 获取玩家穿戴的皮肤是否为多关节官方4d皮肤
    * [IsHighLevelOfficialSkin](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/属性.html#ishighlevelofficialskin>) —— 获取玩家穿戴的皮肤是否为史诗及以上的官方4d皮肤
    * [IsHighLevelMultiJointOfficialSkin](</dev/mcmanual/mc-dev/mcdocs/1-ModAPI/接口/玩家/属性.html#ishighlevelmultijointofficialskin>) —— 获取玩家穿戴的皮肤是否为史诗及以上的多关节官方4d皮肤
...
![](/dev/mcmanual/mc-dev/assets/img/0_1.2d47f874.png)
...
![](/dev/mcmanual/mc-dev/assets/img/0_2.0d071ff6.jpg)

## 新增支持

### MOD SDK

为了方便开发者们在脚本中判断当前玩家皮肤状态，新增了三个接口和一个事件。 开发者可在事件当中判定**当前皮肤是否是官方，从而决定是否修改模型。**

也请开发者注意[**规范概要**](<#%E8%A7%84%E8%8C%83%E6%A6%82%E8%A6%81>)，**非必要情况不修改模型。如需修改，也遵循照官方模型规范**
...
---|---|---|---  
4D测试皮肤 | 传说 | 是 | ![](/dev/mcmanual/mc-dev/assets/img/0_3.2a9adffd.png)  
黑洞之心 | 传说 | 否 | ![](/dev/mcmanual/mc-dev/assets/img/0_4.9c661632.png)  
云霄战姬 | 稀有 | 否 | ![](/dev/mcmanual/mc-dev/assets/img/0_5.fd3fc9e5.png)  
4D学生晴音 | 稀有 | 否 | ![](/dev/mcmanual/mc-dev/assets/img/0_6.909f681a.png)  
...
![](/dev/mcmanual/mc-dev/assets/img/0_7.a12edbd4.png)

选择下方的皮肤选项，可以看到除了默认的史蒂夫和爱丽克丝以外新增4款4D皮肤皮肤，选择皮肤后即可开始测试

![](/dev/mcmanual/mc-dev/assets/img/0_8.cc9a340c.png)
...
![](/dev/mcmanual/mc-dev/assets/img/0_9.49dac2ea.png)

在配置界面中可以切换下方的皮肤

![](/dev/mcmanual/mc-dev/assets/img/0_10.a049befb.png)

  3. 局内切换 进入游戏时，会触发一次UpdatePlayerSkinClient客户端事件


点击右上角菜单，选择切换皮肤选项，即可选择其他4D皮肤

![](/dev/mcmanual/mc-dev/assets/img/0_11.4ccb595a.png)
