...
![控件对象结构](/dev/mcmanual/mc-dev/assets/img/1.9835acb6.png)
...
![控件对象结构](/dev/mcmanual/mc-dev/assets/img/2.943289c2.png)
...
#### 更多UI控件对象文档与接口详见[这里](<../../mcdocs/1-ModAPI/接口/自定义UI/UI控件.html#baseuicontrol>)，代码示例详见UIDemoMod中的文本与按钮范例
