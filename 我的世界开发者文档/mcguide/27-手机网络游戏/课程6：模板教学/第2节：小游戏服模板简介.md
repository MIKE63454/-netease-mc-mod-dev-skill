...
![](/dev/mcmanual/mc-dev/assets/img/WAR1.40bc65fc.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR2.7c7d0619.png)

  * 步骤2：在基岩版服务器找到新建的模板，打开Mod目录，找到neteaseWars中的mod.sql，在远程开发机上执行mod.sql。


![](/dev/mcmanual/mc-dev/assets/img/WAR3.11d88363.png)

  * 步骤3：部署网络服，部署完成后点开发测试，运行小游戏模板。


![](/dev/mcmanual/mc-dev/assets/img/WAR4.8d41f010.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR5.f387a305.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR6.20f23b30.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR7.a3ea245c.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR8.a9739430.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR9.d7af87b2.png)

![](/dev/mcmanual/mc-dev/assets/img/WAR10.67f82fe6.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR11.7a9cdcbf.png)
...
![](/dev/mcmanual/mc-dev/assets/img/WAR13.29c83231.png)

![](/dev/mcmanual/mc-dev/assets/img/WAR12.486e9d75.png)
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/WAR5.f387a305.png
