...
## 插件核心代码解析
  ...
  * 默认对插件的事件、回调机制比较了解，相关基础知识详见[事件简介](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/10-基本概念/1-我的世界基础概念.html>)。
...
![](/dev/mcmanual/mc-dev/assets/img/ditu_27.6f168b1c.png)
...
### 运营指令（1）设置指定服务器地图边界
  ...
  * 控制服返回运营指令执行结果给http的请求方 ![](/dev/mcmanual/mc-dev/assets/img/ditu_28.dbb2fadf.png)


https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/ditu_27.6f168b1c.png
