...
## 了解与试用插件
  ...
  * 打开studio，选择【新建】-->【基岩版网络服】 ![](/dev/mcmanual/mc-dev/assets/img/ditu_01.db0a0ce6.png)
  * 修改网络服名称为【地图属性插件微调】
  * 账号、用户名、机器配置等信息，请根据申请获取到的开发服务器信息填写 ![](/dev/mcmanual/mc-dev/assets/img/ditu_02.bb3c3962.png)
  * 选择【游戏配置】-->【大厅服】-->【Mod的下拉菜单】-->【获取公共Mod】 ![](/dev/mcmanual/mc-dev/assets/img/ditu_03.825c2946.png)
  * 选择**地图属性插件** ，点击【全部下载】，等待下载完成后关闭此弹出界面 ![](/dev/mcmanual/mc-dev/assets/img/ditu_04.3a07fe10.png)
  * 再次点击【Mod的下拉菜单】，选中【neteaseMapAttrs】插件 ![](/dev/mcmanual/mc-dev/assets/img/ditu_05.4b08da1f.png)
  * 点击【下一步】开始配置游戏服 ![](/dev/mcmanual/mc-dev/assets/img/ditu_06.974bd45f.png)
  * 存粹为了体验**地图属性插件** 的部分功能，不需要部署游戏服，直接点击【下一步】，开始配置控制服 ![](/dev/mcmanual/mc-dev/assets/img/ditu_07.785ed6fa.png)
  * **地图属性插件** 包含控制服插件，点击【Mod的下拉菜单】，选中【neteaseMapAttrsMaster】插件 ![](/dev/mcmanual/mc-dev/assets/img/ditu_08.8a7fb98f.png)
  * 控制服配置完成，点击下一步配置功能服 ![](/dev/mcmanual/mc-dev/assets/img/ditu_09.d2f58f14.png)
  * **地图属性插件** 不包含控制服插件，直接点击【下一步】，配置代理服 ![](/dev/mcmanual/mc-dev/assets/img/ditu_10.dd1c1c48.png)
  * 代理服不支持插件功能，直接点击【完成】，结束【游戏配置】
  * 【数据库】分页的配置信息，请根据申请获取到的开发服务器信息填写
  * 【更多】分页的配置信息，在开发阶段直接使用默认即可，无需修改 ![](/dev/mcmanual/mc-dev/assets/img/ditu_11.907d31c2.png)
  * 在studio选择【基岩版服务器】-->【网络服开发】-->选中【地图属性插件微调】-->点击【部署】，等待服务器部署完成 ![](/dev/mcmanual/mc-dev/assets/img/ditu_12.3e82a939.png)
  * 点击【开发测试】即可启动客户端体验**地图属性插件** 的功能 ![](/dev/mcmanual/mc-dev/assets/img/ditu_13.c8b65f20.png)
...
### 获取插件的源码
  ...
  * 在studio选中【基岩版服务器】-->【服务器Mod】-->选中【neteaseMapAttrsMaster】or 【neteaseMapAttrs】-->点击【更多】 ![](/dev/mcmanual/mc-dev/assets/img/ditu_14.5e508820.png)
  * 在菜单中点击【打开目录】 ![](/dev/mcmanual/mc-dev/assets/img/ditu_15.4ad8ac10.png)
  * 此时会进入到目标Mod的下载目录，点击【上一层】，即可定位到全部Mod的下载目录 ![](/dev/mcmanual/mc-dev/assets/img/ditu_16.8f55bf9f.png)
  * 【neteaseMapAttrs】和【neteaseMapAttrsMaster】就是**地图属性插件** 的源码目录 ![](/dev/mcmanual/mc-dev/assets/img/ditu_17.628bee91.png)
  * 把源码复制到自己本地的代码目录，方便随时添加注释与修改调试 ![](/dev/mcmanual/mc-dev/assets/img/ditu_18.de04515e.png)
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/ditu_04.3a07fe10.png
