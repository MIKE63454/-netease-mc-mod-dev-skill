...
作者：LT_Name  
原文： [server.properties (opens new window)](<https://www.nukkit-mot.com/zh/docs/server-config/server-properties>)
...
版本自 [BE 1.17.0 (opens new window)](<https://minecraft.wiki/w/Bedrock_Edition_1.17.0>) 起
