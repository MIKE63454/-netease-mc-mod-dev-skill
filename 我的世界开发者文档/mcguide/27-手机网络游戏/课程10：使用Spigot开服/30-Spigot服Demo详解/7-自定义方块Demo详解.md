...
[示例Demo](</dev/mcmanual/mc-dev/mcguide/27-手机网络游戏/课程10：使用Spigot开服/99-下载内容.html#示例demo>)中的CustomBlockDemo包含客户端Mod
...
## 开发流程
  ...
  * 自定义方块1-3
    ...
    1. 参照[自定义方块实体概述](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/15-自定义游戏内容/2-自定义方块/0-自定义方块概述.html>) 、[自定义方块Json组件](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/15-自定义游戏内容/2-自定义方块/1-JSON组件.html>),增加对应方块定义、Json组件 ![示例4](/dev/mcmanual/mc-dev/assets/img/2.008bf700.png)
...
[code] ```
    ...
    ```
```
    3. 最终效果如下: ![效果1](/dev/mcmanual/mc-dev/assets/img/2.d7aa7a1c.gif)
  * 自定义松鼠方块

    1. 参照[自定义方块实体外观](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/15-自定义游戏内容/2-自定义方块/4.1-自定义方块实体外观.html>)，定义方块实体、动画controller、动画、骨骼模型、贴图等 ![示例4](/dev/mcmanual/mc-dev/assets/img/1.f9f3fa42.png)
...
[code] ```
    ...
    ```
```
    4. 最终效果如下： ![效果2](/dev/mcmanual/mc-dev/assets/img/1.27bc6580.gif)
