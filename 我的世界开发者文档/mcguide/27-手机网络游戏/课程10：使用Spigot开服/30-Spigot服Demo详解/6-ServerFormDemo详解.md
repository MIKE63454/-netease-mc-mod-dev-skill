...
基础的用法和 [Geyser官方文档 (opens new window)](<https://wiki.geysermc.org/geyser/forms/>) 中演示的相差不大，只是发送逻辑需要通过SpigotMaster调用，而不是Floodgate插件
...
```
![依赖](/dev/mcmanual/mc-dev/assets/img/4.e027477d.png)
...
```
  * 具体代码示例如下：
[code] ModalForm.Builder builder = ModalForm.builder()
            .title("Title")
            .content("Content")
            .button1("Button 1")
            .button2("Button 2")
...
![示例1](/dev/mcmanual/mc-dev/assets/img/1.63321d1c.png)
...
```
  * 具体代码示例如下：
[code] SimpleForm simpleForm = SimpleForm.builder()
            .title("Title")
            .content("Content")
...
![示例2](/dev/mcmanual/mc-dev/assets/img/2.b44686c6.png)
...
```
  * 具体代码示例如下：
[code] CustomForm customForm = CustomForm.builder()
            .title("Title")
...
![示例3](/dev/mcmanual/mc-dev/assets/img/3.1ddb56e9.png)
...
```
  * 具体代码示例如下：
[code] CustomForm customForm1 = CustomForm.builder()
...
在阅读下述内容前，默认开发者已阅读过 [客户端ui开发相关知识](</dev/mcmanual/mc-dev/mcguide/18-界面与交互/2-从零开始创建UI.html>)

同时默认开发者已阅读过 [客户端基础ui知识 (opens new window)](<https://wiki.bedrock.dev/json-ui/json-ui-intro.html>)
...
[code] /showForm 5
```
![示例5](/dev/mcmanual/mc-dev/assets/img/5.82ad94db.png)


### 修改流程

  * 复制一份引擎中的server_form.json(具体位于开发包/data/resource_packs/vanilla/ui/下)，到自定义mod中 ![示例6](/dev/mcmanual/mc-dev/assets/img/6.b4f68e7f.png)

  * 首先我们在中间插入一份自定义控件**apollo_demo_switch_long_form** ，**注意代码中注释**
[code] "apollo_demo_switch_long_form" : {
              "type" : "panel",
              "size" : [
                  "100%",
                  "100%"
...
long_form对应的是SimpleForm，custom_form对应的是CustomForm ![示例7](/dev/mcmanual/mc-dev/assets/img/7.6a04a59e.png)

    * Spigot中我们构造如下的Form，把Title设置为**§g**开头 ![示例8](/dev/mcmanual/mc-dev/assets/img/8.7d0e8b24.png)
