...
![注册](/dev/mcmanual/mc-dev/assets/img/shop1.a21d6c6c.png)
...
注意，该接口为首次初始化调用即可，重复调用多次无效
  ...
  * 首先是调用listenForSpigotMasterEvent接口，监听SpigotMaster抛出的事件 分别为：玩家购买物品成功事件、玩家催促发货事件 ![注册1](/dev/mcmanual/mc-dev/assets/img/shop2.2cc26096.png)

  * 收到两个事件其中之一时，调用getPlayerOrderList接口，请求获取玩家订单 ![注册2](/dev/mcmanual/mc-dev/assets/img/shop3.09c82f3c.png)
