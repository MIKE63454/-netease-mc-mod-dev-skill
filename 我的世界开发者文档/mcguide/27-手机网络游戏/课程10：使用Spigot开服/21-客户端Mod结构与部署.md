...
更多模组SDK内容详见: [mod开发简介](<../../20-玩法开发/13-模组SDK编程/2-Python脚本开发/0-脚本开发入门.html#modmain-py是什么>)

## 客户端Mod上传加载流程

  * 如图所示

    * mod目录结构 ![上传1](/dev/mcmanual/mc-dev/assets/img/plugin16.23aae51c.png)
    * studio配置 ![上传](/dev/mcmanual/mc-dev/assets/img/plugin10.5ef96354.png)
  * Geyser读取客户端Mod后，会有如下输出 ![加载成功1](/dev/mcmanual/mc-dev/assets/img/plugin13.f34d5bde.png)
