...
## 简要开发流程
  ...
  * 对于客户端Mod来说，请参照文档 [自定义生物](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/15-自定义游戏内容/3-自定义生物/01-自定义基础生物.html>) 制作生物的模型、贴图、动画等
...
详见文档[自定义实体Demo详解](</dev/mcmanual/mc-dev/mcguide/27-手机网络游戏/课程10：使用Spigot开服/30-Spigot服Demo详解/5-自定义实体Demo详解.html>)

## Q&A

  * 由于配置中的**components** 、**component_groups** 、**events** 均为服务端逻辑，因此均需Spigot插件实现，直接在Json中配置无法生效或效果异常。目前已知可用的**components** 如下：
[code] - 自定义生物components
        ```
        // 设置生物碰撞盒大小
