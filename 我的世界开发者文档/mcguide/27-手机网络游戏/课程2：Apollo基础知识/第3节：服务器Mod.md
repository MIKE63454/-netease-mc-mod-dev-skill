...
![](/dev/mcmanual/mc-dev/assets/img/image071.96fa4242.png)
...
服务端加载的mod目录，不会被传送到客户端。 下面以neteaseAnnounce为例介绍其目录结构：
```python
    	neteaseAnnounceDev
...
modMain.py | 该文件名称不可以更改，用来初始化我们的Mod，具体使用参考[mod开发简介](<../../20-玩法开发/13-模组SDK编程/2-Python脚本开发/0-脚本开发入门.html#modmain-py是什么>)  
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/image071.96fa4242.png
