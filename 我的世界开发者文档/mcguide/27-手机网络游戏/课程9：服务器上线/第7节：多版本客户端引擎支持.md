...
![image-20211015153007727](/dev/mcmanual/mc-dev/assets/img/image-20211015153007727.a96a3b66.png)

![image-20211015153253908](/dev/mcmanual/mc-dev/assets/img/image-20211015153253908.42c609d8.png)

​ 游戏服需要同时部署多个版本，并且每种类型的游戏服都要部署多个版本，这里同时部署1.23和1.24两个版本的game

![image-20211015153406700](/dev/mcmanual/mc-dev/assets/img/image-20211015153406700.706b0ffd.png)

![image-20211015170824022](/dev/mcmanual/mc-dev/assets/img/image-20211015170824022.49d51655.png)

控制服配置为多个版本中最高版本，这里配置为1.24版本

![image-20211015153719169](/dev/mcmanual/mc-dev/assets/img/image-20211015153719169.b136f82a.png)

功能服配置为多个版本中最高版本，这里配置为1.24版本

![image-20211015153546589](/dev/mcmanual/mc-dev/assets/img/image-20211015153546589.40d5db16.png)

代理服配置为多个版本中最高版本，这里配置为1.24版本

![image-20211015145555301](/dev/mcmanual/mc-dev/assets/img/image-20211015145555301.97e8ee72.png)
