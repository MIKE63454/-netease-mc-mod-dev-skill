...
本节内容可查阅[视频教程 (opens new window)](<https://cc.163.com/act/m/daily/iframeplayer/?id=5faa58dc5655da63cc2d8a5d>)的**官方mod插件** 小节
...
![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin01.b911a950.png)
...
![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin02.b1f45adc.png)

    * 登录到远程开发机

    * 执行下面命令进入mysql：mysql -h机器ip -p数据库密码 -u数据库用户名。
[code] mysql -h127.0.0.1 -uminecraft -pminecraft
```
...
```
![image-20191230170155729](/dev/mcmanual/mc-dev/assets/img/chajian_sql.a2eefa4f.png)

  * 修改neteaseAnnounce目录下的mod.json配置，

![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin03.af3aab44.png)

![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin04.b3d816af.png)

  * 新建空白网络服，在大厅服配置neteaseAnnounce、在控制服配置neteaseAnnounceMaster、在功能服配置neteaseAnnounceService。

![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin05.b0bcec62.png)
...
![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin06.6fd53ba4.png)

![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin07.97a52338.png)

![image-20200221210532737](/dev/mcmanual/mc-dev/assets/img/firstplugin08.6af656e9.png)

  * 在游戏中查看效果

![image-20191230170211461](/dev/mcmanual/mc-dev/assets/img/image-20191230170211461.8a6c11c9.png)


https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/image-20200221210608332.eccd8edb.png
