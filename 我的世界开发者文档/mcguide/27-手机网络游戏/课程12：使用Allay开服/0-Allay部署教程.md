...
本系列教程主要侧重于网易版相关内容。有关Allay的更多文档，请移步至[AllayMC官方文档站 (opens new window)](<https://docs.allaymc.org>)。
...
Allay 需要**Java 21** 才能运行。市面上有多种 Java 发行版，但我们推荐以下版本：
  ...
  * [**GraalVM** (opens new window)](<https://www.graalvm.org/>) – 提供更好的性能
  * [**OpenJDK** (opens new window)](<https://adoptium.net/>) – 提供更佳的稳定性
...
[AllayLauncher (opens new window)](<https://github.com/AllayMC/AllayLauncher>)是一个轻量级、快速的工具（用C++编写），能帮您轻松下载、更新和管理您的Allay实例。
...
请从[GitHub Releases (opens new window)](<https://github.com/AllayMC/Allay/releases/latest>)页面获取最新稳定版本。您也可以尝试[Nightly Build (opens new window)](<https://github.com/AllayMC/Allay/releases/tag/nightly>)。
