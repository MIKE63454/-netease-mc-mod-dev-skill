...
用MCStudio进入游戏，可以看到玩家前方有三个NPC： ![img](/dev/mcmanual/mc-dev/assets/img/wps11.e18e886f.jpg)
...
匹配过程如下所示： ![img](/dev/mcmanual/mc-dev/assets/img/wps12.891d5274.jpg)
...
备注：新建一个mod.json于ServiceMod/developer_mods/AwsomeService下面，mod.json的内容是 { "netgame_mod_name": null, "netgame_mod_version": "1.0.0", "min_app_version": null, "author": null, "module_names": ["awsome_match"], "support_server_type": null "unsupport_app_version": null, "CustomPath": null }
