...
​ [ SetKeepResourceWhenTransfer ](<../../../mcdocs/1-ModAPI/接口/通用/调试.html#setkeepresourcewhentransfer>)

​ [ GetKeepResourceWhenTransfer ](<../../../mcdocs/1-ModAPI/接口/通用/调试.html#getkeepresourcewhentransfer>)
...
​ [ SetResourceFastload ](<../../../mcdocs/1-ModAPI/接口/通用/调试.html#setresourcefastload>)

​ [ GetResourceFastload ](<../../../mcdocs/1-ModAPI/接口/通用/调试.html#getresourcefastload>)
...
#### ![](/dev/mcmanual/mc-dev/assets/img/quick04.d6a70105.png)

  * ​ 步骤2：选择应用快切之后的服务器命名，将点击“应用快速切服”，将生成快切网络。


![](/dev/mcmanual/mc-dev/assets/img/quick01.32f862de.png)

  * ​ 步骤3：新生成的快切网络服中，大厅服、游戏服将额外生成一个commonRes的Mod，并自动勾选。


![](/dev/mcmanual/mc-dev/assets/img/quick03_1.1092a8ea.png)

![](/dev/mcmanual/mc-dev/assets/img/quick03_2.7dc35952.png)

![](/dev/mcmanual/mc-dev/assets/img/quick03_3.193eeb84.png)

  * ​ 步骤4：调用接口：[ SetKeepResourceWhenTransfer ](<../../../mcdocs/1-ModAPI/接口/通用/调试.html#setkeepresourcewhentransfer>)，完成快速切服设置。
