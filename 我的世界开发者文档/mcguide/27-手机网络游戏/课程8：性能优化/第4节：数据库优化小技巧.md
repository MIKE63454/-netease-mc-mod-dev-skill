...
```
  * 添加索引前 ![image.png](/dev/mcmanual/mc-dev/assets/img/mysql001.c730acac.png)
  * 添加索引后
```python
    ALTER TABLE playerLevelHistroy ADD INDEX lv_time_index (`level`, `reachTime`);
```
![image.png](/dev/mcmanual/mc-dev/assets/img/mysql002.f561d6a1.png)
...
```
  * EXPLAIN之后的结果为 ![image.png](/dev/mcmanual/mc-dev/assets/img/mysql003.bbd16dd3.png)
  * 没有索引的情况下性能堪虑，这里就需要添加索引
```python
    ALTER TABLE playerLevelHistroy ADD INDEX uid_index (`uid`);
```
  * 重新EXPLAIN的结果为 ![image.png](/dev/mcmanual/mc-dev/assets/img/mysql004.e0b27f5e.png)
...
```
![image.png](/dev/mcmanual/mc-dev/assets/img/mysql005.63d7c2b1.png)
