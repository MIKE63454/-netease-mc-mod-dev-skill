...
![](/dev/mcmanual/mc-dev/assets/img/6_1.37231bf7.jpg)

【手动打包】：在尝试直接打包地图时，需注意包体应有且仅有一个顶级文件夹目录。在对地图文件夹右键压缩成zip文档后，即可将包体上传至开发者平台。

#### 联机地图：

![](/dev/mcmanual/mc-dev/assets/img/6_2.dcb6ea8d.jpg)

![](/dev/mcmanual/mc-dev/assets/img/6_3.48593182.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/6_4.bfeb97ec.jpg)

【手动打包】：在尝试手动打包Add-on组件时，请直接框选材质包文件夹和行为包文件夹后右键压缩成zip文档，即可将包体上传至开发者平台。

#### 材质光影：

![](/dev/mcmanual/mc-dev/assets/img/6_5.bf6530d1.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/6_6.78ea418f.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/6_7.6e0c74e8.jpg)

【手动打包】：在尝试直接打包地图时，请直接对地图文件夹右键压缩成7z文档后，即可将包体上传至开发者平台。

#### MOD：

![](/dev/mcmanual/mc-dev/assets/img/6_8.fb9cc5ff.jpg)

![](/dev/mcmanual/mc-dev/assets/img/6_9.6dfc1089.jpg)

【手动打包】：在尝试手动打包MOD组件时，请将Mod Jar文件嵌套进一个新的文件夹内。再对新的文件夹右键压缩成7z文档，即可将包体上传至开发者平台。

#### 材质：

![](/dev/mcmanual/mc-dev/assets/img/6_10.395f81dd.jpg)

【手动打包】：右键框选所有内容压缩成 zip 文档，再将zip文件放入一个文件夹内，最后对文件夹进行7z格式的打包后即可上传至开发者平台。

#### 光影：

![](/dev/mcmanual/mc-dev/assets/img/6_11.b7a42ea7.jpg)

【手动打包】：右键框选所有内容压缩成 zip 文档，再将zip文件放入一个文件夹内，最后对文件夹进行7z格式的打包后即可上传至开发者平台。

#### 皮肤：

![](/dev/mcmanual/mc-dev/assets/img/6_12.b234ecb7.jpg)
...
![](/dev/mcmanual/mc-dev/assets/img/6_13.1dd18829.jpg)

![](/dev/mcmanual/mc-dev/assets/img/6_14.1d2dcf0d.jpg)

  1. 如果报错组件是PE组件且是Add-on，请在行为包(behavior_packs)和资源包(resource_packs)文件夹中打开manifest文件，用网络在线工具重新再生成uuid后替换json文件内的uuid的值即可；生成工具：<https://www.uuidgenerator.net/>[ (opens new window)](<https://www.uuidgenerator.net/>)
...
https://mc.res.netease.com/pc/zt/20201109161633/mc-dev/assets/img/6_1.37231bf7.jpg
