...
由上述例子可以得出  
在开发模组时，应该避免在 ServerSystem 下的子类引用客户端的接口和方法 如果无法满足要求，可以前往**开发者平台-反馈与建议** 或者 **[Github接口建议 (opens new window)](<https://github.com/MCNeteaseDevs/SDK-Campaign/issues>) 提出接口建议
