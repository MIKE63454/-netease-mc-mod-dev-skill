...
自定义重力方块可以模拟[下落的方块 (opens new window)](<https://zh.minecraft.wiki/w/%E4%B8%8B%E8%90%BD%E7%9A%84%E6%96%B9%E5%9D%97>)，并且支持在组件中修改配置、python监听事件。
...
可参考[CustomBlocksMod](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/13-模组SDK编程/60-Demo示例.html#CustomBlocksMod>)中的customblocks:customblocks_test_heavy.json。
```python
    {
