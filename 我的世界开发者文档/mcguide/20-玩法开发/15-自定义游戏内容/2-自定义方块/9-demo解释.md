...
[CustomBlocksMod](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/13-模组SDK编程/60-Demo示例.html#CustomBlocksMod>)中定义了以下自定义方块：
...
演示了自定义方块实体相关功能，详细解释见[自定义方块实体](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/15-自定义游戏内容/2-自定义方块/4-自定义方块实体.html#demo>)文档
