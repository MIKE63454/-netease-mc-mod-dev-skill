...
## 注册
  ...
  3. 在`behavior/netease_items_beh`的json中添加[netease:armor](<#json%E7%BB%84%E4%BB%B6>)组件
```python
    {
      "format_version": "1.10",
      "minecraft:item": {
...
```
  6. 在resource目录下创建`attachables`目录，创建新json描述文件，其中可配置的参数详见[json组件](<#json%E7%BB%84%E4%BB%B6>)
[code] {
...
enchantment | int | 0 | 盔甲的附魔能力。该值的解释见[官方wiki (opens new window)](<https://zh.minecraft.wiki/w/%E9%99%84%E9%AD%94%EF%BC%88%E7%89%A9%E5%93%81%E4%BF%AE%E9%A5%B0%EF%BC%89>)  
armor_slot | int |  | 盔甲槽位，详见[ ArmorSlotType ](<../../../../mcdocs/1-ModAPI/枚举值/ArmorSlotType.html>)  
toughness | int | 0 | 盔甲韧性，范围0~20，详见[盔甲机制 (opens new window)](<https://zh.minecraft.wiki/w/%E7%9B%94%E7%94%B2%E6%9C%BA%E5%88%B6>)  
knockback_resistance | float | 0.0 | 击退抗性，范围0~1，详见[伤害-击退抗性 (opens new window)](<https://zh.minecraft.wiki/w/%E4%BC%A4%E5%AE%B3#%E5%87%BB%E9%80%80%E6%8A%97%E6%80%A7>)  
...
[CustomItemsMod](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/13-模组SDK编程/60-Demo示例.html#CustomItemsMod>)中定义了一个自定义装备：
