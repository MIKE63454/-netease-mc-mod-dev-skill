...
population_control | str | 生成生物的种类，每一种类都有生成个数的限制，可选的值为：  
animal  
monster  
water_animal  
villager  
...
示例[CustomBiomesMod](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/13-模组SDK编程/60-Demo示例.html#CustomBiomesMod>)中，对dm4于dm5两个自定义维度的生物生成做了一些调整。
