...
![image-20210708164630959](/dev/mcmanual/mc-dev/assets/img/image-20210708164630959.2b40dfa5.png)
...
![image-20210708174313373](/dev/mcmanual/mc-dev/assets/img/image-20210708174313373.648f8aa4.png)
...
![image-20210708194748169](/dev/mcmanual/mc-dev/assets/img/image-20210708194748169.8fa1e63b.png)

将旋转的简易变换动画零件的属性按下图修改：

![image-20210708194845045](/dev/mcmanual/mc-dev/assets/img/image-20210708194845045.479d4b66.png)

将缩放的简易变换动画零件的属性按下图修改：

![image-20210708194920975](/dev/mcmanual/mc-dev/assets/img/image-20210708194920975.d8f5c728.png)

点击保存，然后运行，可以看到3个特效分别播放着不同的变换动画。

![move_rotate_scale](/dev/mcmanual/mc-dev/assets/img/move_rotate_scale.777d3a31.gif)
...
![image-20210708200628881](/dev/mcmanual/mc-dev/assets/img/image-20210708200628881.7ab0a9f1.png)
...
![image-20210708201820063](/dev/mcmanual/mc-dev/assets/img/image-20210708201820063.e790763d.png)

回到关卡编辑器后，发现3个动效的子节点名称都被修改了，且原来未改动过关键帧1的《移动》预设的关键帧1已经应用了本体的缩放修改。

![image-20210708202216756](/dev/mcmanual/mc-dev/assets/img/image-20210708202216756.e7d03689.png)
...
![image-20210712144310664](/dev/mcmanual/mc-dev/assets/img/image-20210712144310664.fc74a8fd.png)

  * 使用预加载属性前，需要先设定出生点，这个可以通过地图编辑器=>菜单栏=>出生点功能进行设置。


![image-20210712145200977](/dev/mcmanual/mc-dev/assets/img/image-20210712145200977.d413b55a.png)

  * 创建一个空预设，改名为GameManager，预加载通常与常加载一并使用，它不会产生坐标更新，将变换更新间隔设为0


![image-20210712145415830](/dev/mcmanual/mc-dev/assets/img/image-20210712145415830.d9aaad7d.png)

  * 创建一个空零件，挂接到GameManager预设上，修改零件的InitServer初始化函数为监听聊天事件
[code] def InitServer(self):
...
![image-20210712150334414](/dev/mcmanual/mc-dev/assets/img/image-20210712150334414.45a3ced8.png)
