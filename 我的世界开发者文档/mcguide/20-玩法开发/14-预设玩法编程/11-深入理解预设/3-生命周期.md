...
关于零件的开发规范，详情可以查阅[零件开发规范](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/14-预设玩法编程/12-深入理解零件/6-零件开发规范.html>)。

关于双端实例的通讯与网络同步，我们提供了一些内置API，比如上面这个零件使用到的**NotifyToServer** 与**ListenSelfEvent** ，详情可以查阅[通讯与网络同步](</dev/mcmanual/mc-dev/mcguide/20-玩法开发/14-预设玩法编程/12-深入理解零件/3-通讯与网络同步.html>)。

## 生命周期

预设系统的完整生命周期如下：

![image-20210712200101137](/dev/mcmanual/mc-dev/assets/img/image-20210712200101137.4536985e.png)
