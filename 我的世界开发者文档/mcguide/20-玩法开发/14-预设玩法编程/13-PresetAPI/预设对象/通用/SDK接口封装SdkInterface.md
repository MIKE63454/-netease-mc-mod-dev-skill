...
[GetBlockStates](<#getblockstates>) | **[服务端]** | 获取[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)  
[SetBlockStates](<#setblockstates>) | **[服务端]** | 设置[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)  
[GetBlockAuxValueFromStates](<#getblockauxvaluefromstates>) | **[服务端]** | 根据方块名称和[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)获取方块附加值AuxValue  
[GetBlockStatesFromAuxValue](<#getblockstatesfromauxvalue>) | **[服务端]** | 根据方块名称和方块附加值AuxValue获取[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)  
...
[LocateStructureFeature](<#locatestructurefeature>) | **[服务端]** | 与[/locate指令 (opens new window)](<https://zh.minecraft.wiki/w/%E5%91%BD%E4%BB%A4/locate>)相似，用于定位原版的部分结构，如海底神殿、末地城等。  
[LocateNeteaseFeatureRule](<#locateneteasefeaturerule>) | **[服务端]** | 与[/locate指令 (opens new window)](<https://zh.minecraft.wiki/w/%E5%91%BD%E4%BB%A4/locate>)相似，用于定位[ 网易自定义特征规则 ](<../../../../15-自定义游戏内容/4-自定义维度/4-自定义特征.html#特征规则（feature-rules）>)  
...
[GetScreenViewInfo](<#getscreenviewinfo>) | **[客户端]** | 获取游戏视角信息。分辨率为1313，618时，画布是376，250的2倍，所以viewport得到的是1313 + (2-(1313%2))，y值类似，可参考[ 《我的世界》界面适配方法 ](<../../../../../18-界面与交互/1-界面编辑器使用说明.html#《我的世界》界面适配方法>)  
...
[GetUserDataInEvent](<#getuserdatainevent>) | **[客户端]**/**[服务端]** | 使物品相关客户端事件的[ 物品信息字典 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)参数带有userData。在mod初始化时调用即可  
...
---|---|---  
entityId | str或int | 实体id  
attrType | int | [AttrType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/AttrType.html>)  
  * 返回值
...
数据类型 | 说明  
---|---  
dict | [ 方块信息字典 ](<../../../../10-基本概念/1-我的世界基础概念.html#方块信息字典>)  
  * 备注
...
---|---|---  
pos | tuple(int,int,int) | 方块位置  
blockDict | dict | [ 方块信息字典 ](<../../../../10-基本概念/1-我的世界基础概念.html#方块信息字典>)  
...
获取[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)
...
设置[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)
...
根据方块名称和[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)获取方块附加值AuxValue
...
根据方块名称和方块附加值AuxValue获取[ 方块状态 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#方块状态>)
...
entityType | int | 期望响应的实体类型，不传则响应所有的实体类型[EntityType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/EntityType.html>)  
  * 返回值
...
数据类型 | 说明  
---|---  
int | 详见[EntityType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/EntityType.html>)  
  * 示例
```python
...
[code]"netease:custom_exploading":{
                    "sequence": [
                      {
                        "filters": {
                      "test": "has_component",
...
参数名 | 数据类型 | 说明  
---|---|---  
featureType | int | 原版的结构类型，[StructureFeatureType](<../../../../../../mcdocs/1-ModAPI/枚举值/StructureFeatureType.html>)枚举  
...
与[/locate指令 (opens new window)](<https://zh.minecraft.wiki/w/%E5%91%BD%E4%BB%A4/locate>)相似，用于定位[ 网易自定义特征规则 ](<../../../../15-自定义游戏内容/4-自定义维度/4-自定义特征.html#特征规则（feature-rules）>)
...
rot | tuple(float,float) | （上下角度，左右角度）实体水平方向的俯仰角度和竖直方向的旋转角度，单位是角度而不是弧度。[MC坐标系说明](<../../../../10-基本概念/10-Vector3.html>)  
...
获取游戏视角信息。分辨率为1313，618时，画布是376，250的2倍，所以viewport得到的是1313 + (2-(1313%2))，y值类似，可参考[ 《我的世界》界面适配方法 ](<../../../../../18-界面与交互/1-界面编辑器使用说明.html#《我的世界》界面适配方法>)
...
数据类型 | 说明  
---|---  
int | [GameType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/GameType.html>)  
  * 示例
```python
...
entityId | str或int | 实体id  
damage | int | 伤害值  
cause | str | 伤害来源，详见Minecraft枚举值文档的[ActorDamageCause枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/ActorDamageCause.html>)  
...
dict | 基础信息字典，见备注  
  * 备注
    ...
    * auxValue默认值是0，可以不设置。如果物品不存在，返回值为None 关键字 | 数据类型 | 说明  
---|---|---  
...
pickaxe | 镐  
dye | 骨粉  
    * 工具等级代表不同的材质，没有工具等级时为值-1，工具等级与材质对应关系如下 工具等级 | 材质  
---|---  
0 | 木制/金制工具  
1 | 石制工具  
2 | 铁制工具  
...
---|---|---  
playerId | str | 玩家ID  
posType | int | [ItemPosType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/ItemPosType.html>)  
...
数据类型 | 说明  
---|---  
dict | [ 物品信息字典 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)，没有物品则返回None  
  * 示例
```python
...
数据类型 | 说明  
---|---  
list(tuple(int,int)) | list中每个tuple由附魔类型([EnchantType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/EnchantType.html>))和附魔等级组成。没有附魔则为空list  
  * 示例
```python
...
参数名 | 数据类型 | 说明  
---|---|---  
itemDict | dict | [ 物品信息字典 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)  
...
使物品相关客户端事件的[ 物品信息字典 ](<../../../../10-基本概念/1-我的世界基础概念.html#物品信息字典#物品信息字典>)参数带有userData。在mod初始化时调用即可
...
参数名 | 数据类型 | 说明  
---|---|---  
biomeType | int | [BiomeType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/BiomeType.html>)  
change | int | [Change枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/Change.html>)  
entityType | int | [EntityType枚举](<../../../../../../mcdocs/1-ModAPI/枚举值/EntityType.html>)  
...
playerId | str | 指定玩家id  
msg | str | 消息内容  
color | str | 颜色样式代码字符串，可参考wiki[样式代码 (opens new window)](<https://zh.minecraft.wiki/w/%E6%A0%B7%E5%BC%8F%E4%BB%A3%E7%A0%81>)，默认为白色  
  * 返回值
