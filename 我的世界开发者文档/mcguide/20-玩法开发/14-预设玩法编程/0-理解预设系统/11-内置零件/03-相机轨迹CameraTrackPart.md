...
![parts006](/dev/mcmanual/mc-dev/assets/img/parts006.7cb9f16f.png)

点击相机轨迹零件，我们可以在属性面板看到其有如下属性:

![parts006](/dev/mcmanual/mc-dev/assets/img/parts007.063e3072.png)
...
![parts009](/dev/mcmanual/mc-dev/assets/img/parts009.e6e22993.png)
...
![cameratrack](/dev/mcmanual/mc-dev/assets/img/cameratrack.74c7cd60.gif)

> 如果需要在游戏中使用脚本调用此零件，可以参考[ 相机轨迹零件的API接口文档 ](<../../../../../mcguide/20-玩法开发/14-预设玩法编程/13-PresetAPI/预设对象/零件/相机轨迹CameraTrackPart.html>)
