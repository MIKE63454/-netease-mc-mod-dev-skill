...
![part001](/dev/mcmanual/mc-dev/assets/img/part001.ad52949b.png)
...
![part002](/dev/mcmanual/mc-dev/assets/img/part002.9d879de7.png)

点击创建，完成Chat零件的创建，资源管理器自动跳转到刚创建的零件的文件夹。

![part003](/dev/mcmanual/mc-dev/assets/img/part003.2ddf1272.png)