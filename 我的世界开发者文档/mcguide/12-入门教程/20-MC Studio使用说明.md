...
![新建作品](/dev/mcmanual/mc-dev/assets/img/studio_image001.f2c5a541.png)
...
![img](/dev/mcmanual/mc-dev/assets/img/studio_image003.539f37f3.png)
...
![img](/dev/mcmanual/mc-dev/assets/img/studio_image004.61b9319c.png)

除了新建地图，也可以新建空白AddOn。AddOn即为附加包，具体的解释可见[wiki (opens new window)](<https://zh.minecraft.wiki/w/%E9%99%84%E5%8A%A0%E5%8C%85>)，AddOn不含地图文件。
...
![img](/dev/mcmanual/mc-dev/assets/img/studio_image005.adda125f.png)

![img](/dev/mcmanual/mc-dev/assets/img/studio_image006.c076c532.png)
...
![img](/dev/mcmanual/mc-dev/assets/img/studio_image007.16f506b3.png)

![img](/dev/mcmanual/mc-dev/assets/img/studio_image008.75d4166a.png)

创建或者导入的作品，能够进行开发测试。开发测试会启动最新的Mod PC开发包对作品进行测试。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image009.69d44f69.png)

MC Studio支持单台电脑测试多人联机玩法。首先启动作品的开发测试（此时就有了第一个客户端并自动建好了局域网房间），然后从工具箱中启动其它的Mod PC开发包。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image010.c76cc804.png)

在新启动的Mod PC开发包中，点击主界面的“游戏”，点击“好友”中已经建立好的房间，这样就能够进入前面作品开发测试时自动建立好的房间，测试多人联机玩法。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image012.d28abd1e.jpg)

![img](/dev/mcmanual/mc-dev/assets/img/studio_image014.dbe30f9e.jpg)

开发测试通过后，在作品页的“更多”菜单中，通过“发布”上传到开发者平台，详见下面的[发布作品](<#%E5%8F%91%E5%B8%83%E4%BD%9C%E5%93%81>)。 在开发测试时，可按F11键在PC和PE操作模式间切换。

### 发布作品

组件类型的作品完成后，需发布到平台，玩家才能够从游戏里的资源中心搜索并下载到你的作品。在作品页的“更多”中，点击“发布”,则会跳转到[开发者平台 (opens new window)](<https://mcdev.webapp.163.com/#/login>)，并为你填写作品的基本信息。

> 若您此前未登录开发者平台则会跳转到登录界面。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image_launch.6102f4c3.png)

在发布资源页面填写完相关信息后，点击立即提交审核，即可将作品提交到官方进行初步审核，为后续的发布和测试做准备。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image_launch-1.861ab497.png)
...
![img](/dev/mcmanual/mc-dev/assets/img/studio_image_homepage.014293d8.png)

_AI知识助理_

AI知识助理可以为你解答在模组开发过程中遇到的问题，并为您定位到相关的官网文档，助力您快速入门我的世界模组开发，详细使用教程请参考[这篇文档](</dev/mcmanual/mc-dev/mcguide/12-入门教程/25-AI知识助理.html>)。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image_aihelper.9a2d0898.png)

_基岩版服务器_

分页中会列出当前开发者账号下的所有网络游戏，可下载到本地进行测试。如果想开发网络游戏，需额外进行申请，通过审批后可获得开服工具和相关资料，进行网络游戏的开发。具体如何开发基岩版网络游戏请参考系列文档中的Apollo部分。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image_peserver.84221519.png)

_Java组件和服务器_

Java作品分页的结构基本同基岩版作品分页。目前MC Studio不支持Java版作品的编辑，仅可导入Java作品进行测试。

![img](/dev/mcmanual/mc-dev/assets/img/studio_image_javamod.16a10710.png)

![img](/dev/mcmanual/mc-dev/assets/img/studio_image_javaserver.b80f2fb3.png)
...
https://nie.res.netease.com/r/pic/20210730/6b8ee910-f423-4421-9627-110415c820ca.png
